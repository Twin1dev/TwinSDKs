...
class UClass* AB_Prj_DartsPoison_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Prj_DartsPoison_C");

	return Clss;
}


// B_Prj_DartsPoison_C B_Prj_DartsPoison.Default__B_Prj_DartsPoison_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Prj_DartsPoison_C* AB_Prj_DartsPoison_C::GetDefaultObj()
{
	static class AB_Prj_DartsPoison_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Prj_DartsPoison_C*>(AB_Prj_DartsPoison_C::StaticClass()->DefaultObject);
