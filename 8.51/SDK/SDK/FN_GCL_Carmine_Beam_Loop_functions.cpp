...
class UClass* AGCL_Carmine_Beam_Loop_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCL_Carmine_Beam_Loop_C");

	return Clss;
}


// GCL_Carmine_Beam_Loop_C GCL_Carmine_Beam_Loop.Default__GCL_Carmine_Beam_Loop_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCL_Carmine_Beam_Loop_C* AGCL_Carmine_Beam_Loop_C::GetDefaultObj()
{
	static class AGCL_Carmine_Beam_Loop_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCL_Carmine_Beam_Loop_C*>(AGCL_Carmine_Beam_Loop_C::StaticClass()->DefaultObject);
