...
class UClass* UGCN_Athena_Event_Sleepy_Impact_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Athena_Event_Sleepy_Impact_C");

	return Clss;
}


// GCN_Athena_Event_Sleepy_Impact_C GCN_Athena_Event_Sleepy_Impact.Default__GCN_Athena_Event_Sleepy_Impact_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Athena_Event_Sleepy_Impact_C* UGCN_Athena_Event_Sleepy_Impact_C::GetDefaultObj()
{
	static class UGCN_Athena_Event_Sleepy_Impact_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Athena_Event_Sleepy_Impact_C*>(UGCN_Athena_Event_Sleepy_Impact_C::StaticClass()->DefaultObject);
