...
class UClass* AGCN_Loop_SirloinBotShroud_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Loop_SirloinBotShroud_C");

	return Clss;
}


// GCN_Loop_SirloinBotShroud_C GCN_Loop_SirloinBotShroud.Default__GCN_Loop_SirloinBotShroud_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCN_Loop_SirloinBotShroud_C* AGCN_Loop_SirloinBotShroud_C::GetDefaultObj()
{
	static class AGCN_Loop_SirloinBotShroud_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCN_Loop_SirloinBotShroud_C*>(AGCN_Loop_SirloinBotShroud_C::StaticClass()->DefaultObject);
