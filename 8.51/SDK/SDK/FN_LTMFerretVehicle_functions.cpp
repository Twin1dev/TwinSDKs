...
class UClass* ALTMFerretVehicle_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LTMFerretVehicle_C");

	return Clss;
}


// LTMFerretVehicle_C LTMFerretVehicle.Default__LTMFerretVehicle_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ALTMFerretVehicle_C* ALTMFerretVehicle_C::GetDefaultObj()
{
	static class ALTMFerretVehicle_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ALTMFerretVehicle_C*>(ALTMFerretVehicle_C::StaticClass()->DefaultObject);
