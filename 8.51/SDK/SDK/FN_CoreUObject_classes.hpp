...
public:
	...
	{
		static void* (*GetInterfaceAddressOriginal)(UObject * a1, UClass * a2) = decltype(GetInterfaceAddressOriginal)(__int64(GetModuleHandleW(0)) + 0x1e73e00);
...
{
public:
	uint8                                        Pad_7[0x38];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_19[0x1B8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2B[0x18];                                      // Fixing Size Of Struct [ Dumper-7 ]
