...
class UClass* ABP_FakeLight_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_FakeLight_C");

	return Clss;
}


// BP_FakeLight_C BP_FakeLight.Default__BP_FakeLight_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_FakeLight_C* ABP_FakeLight_C::GetDefaultObj()
{
	static class ABP_FakeLight_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_FakeLight_C*>(ABP_FakeLight_C::StaticClass()->DefaultObject);
