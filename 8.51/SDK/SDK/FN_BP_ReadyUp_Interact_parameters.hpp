...
public:
	...
	uint8                                        Pad_4A43[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_4AC0[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TScriptInterface<class IFortInventoryOwnerInterface> CallFunc_ReturnBluGloToPlayer_InventoryOwner_CastInput_1; // 0x1F0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FSlateBrush                           CallFunc_MakeBrushFromTexture_ReturnValue_1;       // 0x398(0x88)(None)
	...
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_ObjectiveHandle_2;       // 0x430(0x20)(None)
	...
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_GameplayTags_2;          // 0x498(0x20)(None)
	struct FFortMissionEvent                     K2Node_HandleMissionEvent_MissionEvent_2;          // 0x4B8(0x98)(ConstParm)
	struct FFortClientAnnouncementData_Basic     K2Node_MakeStruct_FortClientAnnouncementData_Basic_1; // 0x550(0xE8)(None)
	...
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_ObjectiveHandle_1;       // 0x648(0x20)(None)
	...
	struct FGameplayTagContainer                 K2Node_HandleMissionEvent_GameplayTags_1;          // 0x6B0(0x20)(None)
