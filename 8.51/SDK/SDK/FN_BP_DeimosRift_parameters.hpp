...
public:
	...
	uint8                                        Pad_2649[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext;                        // 0x340(0x18)(None)
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext_1;                      // 0x428(0x18)(None)
