...
public:
	...
	uint8                                        Pad_4838[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TScriptInterface<class IFortPlayerSurveyAnswerableQuestion> CallFunc_GetAnswer_self_CastInput;                 // 0x10(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	struct FFortPlayerSurveyAnswer               CallFunc_GetAnswer_ReturnValue;                    // 0x20(0x18)(None)
	...
	TScriptInterface<class ISingleIndexSelectionModel> CallFunc_CanMoveDelta_self_CastInput;              // 0x48(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	TScriptInterface<class IFortPlayerSurveyAnswerableQuestion> CallFunc_AddOnAnswerChangedDelegate_self_CastInput; // 0xE8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FFortPlayerSurveyDescription          CallFunc_GetDescription_ReturnValue;               // 0x140(0x50)(None)
