...
class UClass* UGCN_Athena_Item_Ashton_Turbo_Strike_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Athena_Item_Ashton_Turbo_Strike_C");

	return Clss;
}


// GCN_Athena_Item_Ashton_Turbo_Strike_C GCN_Athena_Item_Ashton_Turbo_Strike.Default__GCN_Athena_Item_Ashton_Turbo_Strike_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Athena_Item_Ashton_Turbo_Strike_C* UGCN_Athena_Item_Ashton_Turbo_Strike_C::GetDefaultObj()
{
	static class UGCN_Athena_Item_Ashton_Turbo_Strike_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Athena_Item_Ashton_Turbo_Strike_C*>(UGCN_Athena_Item_Ashton_Turbo_Strike_C::StaticClass()->DefaultObject);
