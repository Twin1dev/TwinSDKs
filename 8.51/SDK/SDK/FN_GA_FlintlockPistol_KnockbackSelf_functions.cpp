...
class UClass* UGA_FlintlockPistol_KnockbackSelf_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_FlintlockPistol_KnockbackSelf_C");

	return Clss;
}


// GA_FlintlockPistol_KnockbackSelf_C GA_FlintlockPistol_KnockbackSelf.Default__GA_FlintlockPistol_KnockbackSelf_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_FlintlockPistol_KnockbackSelf_C* UGA_FlintlockPistol_KnockbackSelf_C::GetDefaultObj()
{
	static class UGA_FlintlockPistol_KnockbackSelf_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_FlintlockPistol_KnockbackSelf_C*>(UGA_FlintlockPistol_KnockbackSelf_C::StaticClass()->DefaultObject);
