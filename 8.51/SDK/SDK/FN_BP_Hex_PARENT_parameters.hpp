...
public:
	...
	struct FFortMissionDetails                   CallFunc_GetTileMissionDetails_MissionDetails;     // 0x180(0x168)(None)
	...
	class FText                                  CallFunc_Get_Conning_Color_From_Difficulty_Value_TooltipText; // 0x308(0x18)(None)
	...
	struct FFortMissionDetails                   CallFunc_GetTileMissionDetails_MissionDetails_1;   // 0x3D0(0x168)(None)
	...
	struct FFortHomeBaseInfo                     CallFunc_GetHomeBaseInfoForPlayer_Result;          // 0x570(0x40)(None)
