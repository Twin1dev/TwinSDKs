...
public:
	...
	struct FGameplayTagContainer                 CallFunc_BreakGameplayCueParameters_AggregatedSourceTags; // 0x110(0x20)(None)
	struct FGameplayTagContainer                 CallFunc_BreakGameplayCueParameters_AggregatedTargetTags; // 0x130(0x20)(None)
	...
	uint8                                        Pad_4DF2[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
