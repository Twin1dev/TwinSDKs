...
class UClass* UGCN_Carmine_Jump_Liftoff_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Carmine_Jump_Liftoff_C");

	return Clss;
}


// GCN_Carmine_Jump_Liftoff_C GCN_Carmine_Jump_Liftoff.Default__GCN_Carmine_Jump_Liftoff_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Carmine_Jump_Liftoff_C* UGCN_Carmine_Jump_Liftoff_C::GetDefaultObj()
{
	static class UGCN_Carmine_Jump_Liftoff_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Carmine_Jump_Liftoff_C*>(UGCN_Carmine_Jump_Liftoff_C::StaticClass()->DefaultObject);
