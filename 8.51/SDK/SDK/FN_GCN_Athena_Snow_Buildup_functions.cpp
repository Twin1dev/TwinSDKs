...
class UClass* UGCN_Athena_Snow_Buildup_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Athena_Snow_Buildup_C");

	return Clss;
}


// GCN_Athena_Snow_Buildup_C GCN_Athena_Snow_Buildup.Default__GCN_Athena_Snow_Buildup_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Athena_Snow_Buildup_C* UGCN_Athena_Snow_Buildup_C::GetDefaultObj()
{
	static class UGCN_Athena_Snow_Buildup_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Athena_Snow_Buildup_C*>(UGCN_Athena_Snow_Buildup_C::StaticClass()->DefaultObject);
