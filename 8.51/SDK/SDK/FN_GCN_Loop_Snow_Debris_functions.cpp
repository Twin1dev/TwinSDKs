...
class UClass* AGCN_Loop_Snow_Debris_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Loop_Snow_Debris_C");

	return Clss;
}


// GCN_Loop_Snow_Debris_C GCN_Loop_Snow_Debris.Default__GCN_Loop_Snow_Debris_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCN_Loop_Snow_Debris_C* AGCN_Loop_Snow_Debris_C::GetDefaultObj()
{
	static class AGCN_Loop_Snow_Debris_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCN_Loop_Snow_Debris_C*>(AGCN_Loop_Snow_Debris_C::StaticClass()->DefaultObject);
