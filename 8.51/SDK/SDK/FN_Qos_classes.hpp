...
{
public:
	uint8                                        Pad_30B[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_30C[0x10];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_30F[0x20];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_311[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_315[0x20];                                     // Fixing Size Of Struct [ Dumper-7 ]
