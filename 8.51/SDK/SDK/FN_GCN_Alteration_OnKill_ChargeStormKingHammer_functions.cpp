...
class UClass* AGCN_Alteration_OnKill_ChargeStormKingHammer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Alteration_OnKill_ChargeStormKingHammer_C");

	return Clss;
}


// GCN_Alteration_OnKill_ChargeStormKingHammer_C GCN_Alteration_OnKill_ChargeStormKingHammer.Default__GCN_Alteration_OnKill_ChargeStormKingHammer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCN_Alteration_OnKill_ChargeStormKingHammer_C* AGCN_Alteration_OnKill_ChargeStormKingHammer_C::GetDefaultObj()
{
	static class AGCN_Alteration_OnKill_ChargeStormKingHammer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCN_Alteration_OnKill_ChargeStormKingHammer_C*>(AGCN_Alteration_OnKill_ChargeStormKingHammer_C::StaticClass()->DefaultObject);
