...
public:
	...
	struct FFortReceivedItemLootInfo             CallFunc_Array_Get_Item;                           // 0x70(0x28)(None)
	...
	struct FFortReceivedItemLootInfo             CallFunc_Array_Get_Item_1;                         // 0x108(0x28)(None)
	...
	struct FFortRarityItemData                   CallFunc_BPGetRarityData_ReturnValue;              // 0x140(0x80)(None)
	...
	struct FFortAnalyticsEventAttribute          CallFunc_ConstructAnalyticsAttribute_ReturnValue;  // 0x370(0x20)(None)
	class FString                                CallFunc_GetDisplayName_ReturnValue;               // 0x390(0x10)(ZeroConstructor, HasGetValueTypeHash)
	struct FFortAnalyticsEventAttribute          CallFunc_ConstructAnalyticsAttribute_ReturnValue_1; // 0x3A0(0x20)(None)
	...
	class FText                                  K2Node_Select_Default_3;                           // 0x448(0x18)(None)
	class FText                                  K2Node_Select_Default_4;                           // 0x460(0x18)(None)
};
