...
class UClass* ABP_PoisonDartTrap_Floor_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_PoisonDartTrap_Floor_C");

	return Clss;
}


// BP_PoisonDartTrap_Floor_C BP_PoisonDartTrap_Floor.Default__BP_PoisonDartTrap_Floor_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_PoisonDartTrap_Floor_C* ABP_PoisonDartTrap_Floor_C::GetDefaultObj()
{
	static class ABP_PoisonDartTrap_Floor_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_PoisonDartTrap_Floor_C*>(ABP_PoisonDartTrap_Floor_C::StaticClass()->DefaultObject);
