...
public:
	...
	struct FFortItemEntry                        CallFunc_Array_Get_Item;                           // 0x20(0x120)(None)
	...
	TScriptInterface<class IFortInventoryOwnerInterface> CallFunc_GiveItemToInventoryOwner_InventoryOwner_CastInput; // 0x158(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	...
	uint8                                        Pad_1870[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1871[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
