...
class UClass* AGC_Athena_Fly_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Athena_Fly_C");

	return Clss;
}


// GC_Athena_Fly_C GC_Athena_Fly.Default__GC_Athena_Fly_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_Athena_Fly_C* AGC_Athena_Fly_C::GetDefaultObj()
{
	static class AGC_Athena_Fly_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_Athena_Fly_C*>(AGC_Athena_Fly_C::StaticClass()->DefaultObject);
