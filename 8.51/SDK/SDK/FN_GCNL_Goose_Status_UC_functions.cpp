...
class UClass* AGCNL_Goose_Status_UC_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_Goose_Status_UC_C");

	return Clss;
}


// GCNL_Goose_Status_UC_C GCNL_Goose_Status_UC.Default__GCNL_Goose_Status_UC_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_Goose_Status_UC_C* AGCNL_Goose_Status_UC_C::GetDefaultObj()
{
	static class AGCNL_Goose_Status_UC_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_Goose_Status_UC_C*>(AGCNL_Goose_Status_UC_C::StaticClass()->DefaultObject);
