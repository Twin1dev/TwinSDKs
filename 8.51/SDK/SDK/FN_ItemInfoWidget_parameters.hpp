...
public:
	...
	class FText                                  Temp_text_Variable_10;                             // 0x2E0(0x18)(None)
	class FText                                  Temp_text_Variable_11;                             // 0x2F8(0x18)(None)
	class FText                                  K2Node_Select_Default_1;                           // 0x310(0x18)(None)
	class FText                                  CallFunc_TextToUpper_ReturnValue_1;                // 0x328(0x18)(None)
	...
	class FText                                  CallFunc_Format_ReturnValue_1;                     // 0x450(0x18)(None)
	TArray<struct FFormatArgumentData>           K2Node_MakeArray_Array_2;                          // 0x468(0x10)(ZeroConstructor, ReferenceParm)
	class FText                                  CallFunc_Format_ReturnValue_2;                     // 0x478(0x18)(None)
};
