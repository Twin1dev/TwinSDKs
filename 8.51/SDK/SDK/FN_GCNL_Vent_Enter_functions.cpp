...
class UClass* AGCNL_Vent_Enter_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_Vent_Enter_C");

	return Clss;
}


// GCNL_Vent_Enter_C GCNL_Vent_Enter.Default__GCNL_Vent_Enter_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_Vent_Enter_C* AGCNL_Vent_Enter_C::GetDefaultObj()
{
	static class AGCNL_Vent_Enter_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_Vent_Enter_C*>(AGCNL_Vent_Enter_C::StaticClass()->DefaultObject);
