...
public:
	...
	uint8                                        Pad_641A[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_641C[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData;               // 0xA0(0xB0)(None)
	...
	uint8                                        Pad_6427[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	int32                                        CallFunc_Add_IntInt_ReturnValue_1;                 // 0x1C4(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayAbilityTargetDataHandle      Temp_struct_Variable;                              // 0x1C8(0x28)(None)
	...
	TScriptInterface<class IGameplayTagAssetInterface> CallFunc_HasMatchingGameplayTag_self_CastInput;    // 0x288(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
