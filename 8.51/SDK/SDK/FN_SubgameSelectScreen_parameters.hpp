...
public:
	...
	uint8                                        Pad_3C07[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3C17[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3C25[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_GetAccountGameplayRestrictionText_ReturnValue; // 0x20(0x18)(None)
	...
	uint8                                        Pad_3C34[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  CallFunc_CanPlay_DenialReason;                     // 0x258(0x18)(None)
	...
	class FText                                  CallFunc_GetPlatformDisplayName_ReturnValue;       // 0x308(0x18)(None)
	...
	class FText                                  CallFunc_CanPlay_DenialReason_1;                   // 0x328(0x18)(None)
