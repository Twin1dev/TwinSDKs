...
// struct FFortPlayerSurveyAnswer     CallFunc_GetAnswer_ReturnValue                                   (None)
...
void UPlayerSurveyPanelContents_C::UpdateNextButtonState(class UCommonButton* ActiveNextButton, bool HasMoreQuestions, bool HasAnsweredCurrentQuestion, bool Temp_bool_Variable, TScriptInterface<class IFortPlayerSurveyAnswerableQuestion> CallFunc_GetAnswer_self_CastInput, const struct FFortPlayerSurveyAnswer& CallFunc_GetAnswer_ReturnValue, enum class EFortPlayerSurveyQuestionType CallFunc_GetAnswerType_ReturnValue, bool CallFunc_NotEqual_ByteByte_ReturnValue, class UCommonButton* K2Node_Select_Default, TScriptInterface<class ISingleIndexSelectionModel> CallFunc_CanMoveDelta_self_CastInput, enum class EIndexNavigationResult CallFunc_CanMoveDelta_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
	static class UFunction* Func = nullptr;
