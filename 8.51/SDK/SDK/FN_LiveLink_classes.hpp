...
public:
	...
	uint8                                        Pad_284[0xE];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_28D[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_295[0xA8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_297[0x58];                                     // Fixing Size Of Struct [ Dumper-7 ]
