...
// TScriptInterface<class IFortMountedWeaponInterface>CallFunc_GetHostVehicleCached_self_CastInput                     (ZeroConstructor, IsPlainOldData, NoDestructor)
...
void ATrap_Floor_MountedTurret_C::OnModifyTrapIncomingDamage(float Damage, class AController* EventInstigator, class AActor* DamageCauser, float* OutDamage, bool* bOutConsumeEvent, class AB_MountedTurretAthena_C* K2Node_DynamicCast_AsB_Mounted_Turret_Athena, bool K2Node_DynamicCast_bSuccess, TScriptInterface<class IFortMountedWeaponInterface> CallFunc_GetHostVehicleCached_self_CastInput, class AFortAthenaVehicle* CallFunc_GetHostVehicleCached_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue)
{
