...
class UClass* UGCN_Carmine_ApplyStone_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Carmine_ApplyStone_C");

	return Clss;
}


// GCN_Carmine_ApplyStone_C GCN_Carmine_ApplyStone.Default__GCN_Carmine_ApplyStone_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Carmine_ApplyStone_C* UGCN_Carmine_ApplyStone_C::GetDefaultObj()
{
	static class UGCN_Carmine_ApplyStone_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Carmine_ApplyStone_C*>(UGCN_Carmine_ApplyStone_C::StaticClass()->DefaultObject);
