...
class UClass* ABGA_Athena_SCMachine_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BGA_Athena_SCMachine_C");

	return Clss;
}


// BGA_Athena_SCMachine_C BGA_Athena_SCMachine.Default__BGA_Athena_SCMachine_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABGA_Athena_SCMachine_C* ABGA_Athena_SCMachine_C::GetDefaultObj()
{
	static class ABGA_Athena_SCMachine_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABGA_Athena_SCMachine_C*>(ABGA_Athena_SCMachine_C::StaticClass()->DefaultObject);
