...
public:
	...
	uint8                                        Pad_51CC[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TScriptInterface<class IFortInitializeFromObjectInterface> K2Node_DynamicCast_AsFort_Initialize_from_Object_Interface; // 0x1B8(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
