...
class UClass* ULocalUserParticipation_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("LocalUserParticipation_C");

	return Clss;
}


// LocalUserParticipation_C LocalUserParticipation.Default__LocalUserParticipation_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ULocalUserParticipation_C* ULocalUserParticipation_C::GetDefaultObj()
{
	static class ULocalUserParticipation_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ULocalUserParticipation_C*>(ULocalUserParticipation_C::StaticClass()->DefaultObject);
