...
class UClass* UGA_Athena_PushCannon_Fired_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_PushCannon_Fired_C");

	return Clss;
}


// GA_Athena_PushCannon_Fired_C GA_Athena_PushCannon_Fired.Default__GA_Athena_PushCannon_Fired_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_PushCannon_Fired_C* UGA_Athena_PushCannon_Fired_C::GetDefaultObj()
{
	static class UGA_Athena_PushCannon_Fired_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_PushCannon_Fired_C*>(UGA_Athena_PushCannon_Fired_C::StaticClass()->DefaultObject);
