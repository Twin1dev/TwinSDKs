...
class UClass* AGCL_Carmine_Jump_Dive_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCL_Carmine_Jump_Dive_C");

	return Clss;
}


// GCL_Carmine_Jump_Dive_C GCL_Carmine_Jump_Dive.Default__GCL_Carmine_Jump_Dive_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCL_Carmine_Jump_Dive_C* AGCL_Carmine_Jump_Dive_C::GetDefaultObj()
{
	static class AGCL_Carmine_Jump_Dive_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCL_Carmine_Jump_Dive_C*>(AGCL_Carmine_Jump_Dive_C::StaticClass()->DefaultObject);
