...
public:
	...
	uint8                                        Pad_6A[0x1];                                       // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	class FText                                  CallFunc_Conv_IntToText_ReturnValue_2;             // 0x1B0(0x18)(None)
	...
	class FText                                  K2Node_Select_Default_1;                           // 0x260(0x18)(None)
};
