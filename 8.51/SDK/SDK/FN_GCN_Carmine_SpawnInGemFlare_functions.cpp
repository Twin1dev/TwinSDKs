...
class UClass* UGCN_Carmine_SpawnInGemFlare_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Carmine_SpawnInGemFlare_C");

	return Clss;
}


// GCN_Carmine_SpawnInGemFlare_C GCN_Carmine_SpawnInGemFlare.Default__GCN_Carmine_SpawnInGemFlare_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Carmine_SpawnInGemFlare_C* UGCN_Carmine_SpawnInGemFlare_C::GetDefaultObj()
{
	static class UGCN_Carmine_SpawnInGemFlare_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Carmine_SpawnInGemFlare_C*>(UGCN_Carmine_SpawnInGemFlare_C::StaticClass()->DefaultObject);
