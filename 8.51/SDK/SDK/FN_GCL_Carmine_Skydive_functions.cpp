...
class UClass* AGCL_Carmine_Skydive_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCL_Carmine_Skydive_C");

	return Clss;
}


// GCL_Carmine_Skydive_C GCL_Carmine_Skydive.Default__GCL_Carmine_Skydive_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCL_Carmine_Skydive_C* AGCL_Carmine_Skydive_C::GetDefaultObj()
{
	static class AGCL_Carmine_Skydive_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCL_Carmine_Skydive_C*>(AGCL_Carmine_Skydive_C::StaticClass()->DefaultObject);
