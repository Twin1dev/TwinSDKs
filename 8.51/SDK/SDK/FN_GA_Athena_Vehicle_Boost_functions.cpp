...
class UClass* UGA_Athena_Vehicle_Boost_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Athena_Vehicle_Boost_C");

	return Clss;
}


// GA_Athena_Vehicle_Boost_C GA_Athena_Vehicle_Boost.Default__GA_Athena_Vehicle_Boost_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Athena_Vehicle_Boost_C* UGA_Athena_Vehicle_Boost_C::GetDefaultObj()
{
	static class UGA_Athena_Vehicle_Boost_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Athena_Vehicle_Boost_C*>(UGA_Athena_Vehicle_Boost_C::StaticClass()->DefaultObject);
