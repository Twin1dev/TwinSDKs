...
public:
	...
	struct FGameplayEffectContextHandle          K2Node_MakeStruct_GameplayEffectContextHandle;     // 0x1D8(0x18)(None)
	...
	uint8                                        Pad_3782[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData;               // 0x428(0xB0)(None)
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData_1;             // 0x4D8(0xB0)(None)
