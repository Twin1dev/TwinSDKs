...
class UClass* AB_Laser_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_Laser_C");

	return Clss;
}


// B_Laser_C B_Laser.Default__B_Laser_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_Laser_C* AB_Laser_C::GetDefaultObj()
{
	static class AB_Laser_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_Laser_C*>(AB_Laser_C::StaticClass()->DefaultObject);
