...
class UClass* AGC_Ashton_Indigo_LowGrav_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Ashton_Indigo_LowGrav_C");

	return Clss;
}


// GC_Ashton_Indigo_LowGrav_C GC_Ashton_Indigo_LowGrav.Default__GC_Ashton_Indigo_LowGrav_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_Ashton_Indigo_LowGrav_C* AGC_Ashton_Indigo_LowGrav_C::GetDefaultObj()
{
	static class AGC_Ashton_Indigo_LowGrav_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_Ashton_Indigo_LowGrav_C*>(AGC_Ashton_Indigo_LowGrav_C::StaticClass()->DefaultObject);
