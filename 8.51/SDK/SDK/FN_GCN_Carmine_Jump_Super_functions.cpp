...
class UClass* UGCN_Carmine_Jump_Super_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Carmine_Jump_Super_C");

	return Clss;
}


// GCN_Carmine_Jump_Super_C GCN_Carmine_Jump_Super.Default__GCN_Carmine_Jump_Super_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Carmine_Jump_Super_C* UGCN_Carmine_Jump_Super_C::GetDefaultObj()
{
	static class UGCN_Carmine_Jump_Super_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Carmine_Jump_Super_C*>(UGCN_Carmine_Jump_Super_C::StaticClass()->DefaultObject);
