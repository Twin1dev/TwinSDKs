...
public:
	...
	uint8                                        Pad_580B[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  Temp_text_Variable_7;                              // 0x150(0x18)(None)
	class FText                                  Temp_text_Variable_8;                              // 0x168(0x18)(None)
	...
	class FText                                  Temp_text_Variable_10;                             // 0x1E8(0x18)(None)
	class FText                                  Temp_text_Variable_11;                             // 0x200(0x18)(None)
	...
	struct FSlateBrush                           CallFunc_MakeBrushFromTexture_ReturnValue;         // 0x2B8(0x88)(None)
	class FText                                  CallFunc_TextToUpper_ReturnValue;                  // 0x340(0x18)(None)
	...
	struct FSlateBrush                           CallFunc_MakeBrushFromTexture_ReturnValue_1;       // 0x360(0x88)(None)
	class FText                                  CallFunc_TextToUpper_ReturnValue_1;                // 0x3E8(0x18)(None)
	...
	class FText                                  CallFunc_Conv_StringToText_ReturnValue_2;          // 0x458(0x18)(None)
	...
	class FText                                  CallFunc_TextToUpper_ReturnValue_2;                // 0x478(0x18)(None)
	...
	class FText                                  K2Node_Select_Default_6;                           // 0x4B0(0x18)(None)
	...
	uint8                                        Pad_581A[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class FText                                  K2Node_Select_Default_16;                          // 0x518(0x18)(None)
	...
	class FText                                  K2Node_Select_Default_18;                          // 0x550(0x18)(None)
	class FText                                  Temp_text_Variable_12;                             // 0x568(0x18)(None)
	...
	class FText                                  Temp_text_Variable_13;                             // 0x5E8(0x18)(None)
	...
	class FText                                  K2Node_Select_Default_20;                          // 0x608(0x18)(None)
