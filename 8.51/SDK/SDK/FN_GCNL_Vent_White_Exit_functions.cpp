...
class UClass* AGCNL_Vent_White_Exit_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_Vent_White_Exit_C");

	return Clss;
}


// GCNL_Vent_White_Exit_C GCNL_Vent_White_Exit.Default__GCNL_Vent_White_Exit_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_Vent_White_Exit_C* AGCNL_Vent_White_Exit_C::GetDefaultObj()
{
	static class AGCNL_Vent_White_Exit_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_Vent_White_Exit_C*>(AGCNL_Vent_White_Exit_C::StaticClass()->DefaultObject);
