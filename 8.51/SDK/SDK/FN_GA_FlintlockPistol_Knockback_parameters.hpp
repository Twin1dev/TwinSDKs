...
public:
	...
	TScriptInterface<class IGameplayTagAssetInterface> CallFunc_HasMatchingGameplayTag_self_CastInput_1;  // 0x120(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor)
