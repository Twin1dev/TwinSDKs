...
public:
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext_2;                      // 0x4A8(0x18)(None)
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext_1;                      // 0x590(0x18)(None)
	...
	struct FGameplayEffectContextHandle          K2Node_Event_EffectContext;                        // 0x688(0x18)(None)
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData_1;             // 0x6C8(0xB0)(None)
	...
	struct FGameplayEventData                    K2Node_MakeStruct_GameplayEventData_2;             // 0x868(0xB0)(None)
