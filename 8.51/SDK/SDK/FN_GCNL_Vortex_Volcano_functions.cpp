...
class UClass* AGCNL_Vortex_Volcano_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_Vortex_Volcano_C");

	return Clss;
}


// GCNL_Vortex_Volcano_C GCNL_Vortex_Volcano.Default__GCNL_Vortex_Volcano_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_Vortex_Volcano_C* AGCNL_Vortex_Volcano_C::GetDefaultObj()
{
	static class AGCNL_Vortex_Volcano_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_Vortex_Volcano_C*>(AGCNL_Vortex_Volcano_C::StaticClass()->DefaultObject);
