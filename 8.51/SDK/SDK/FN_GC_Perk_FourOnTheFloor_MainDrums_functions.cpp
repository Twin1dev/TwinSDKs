...
class UClass* AGC_Perk_FourOnTheFloor_MainDrums_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Perk_FourOnTheFloor_MainDrums_C");

	return Clss;
}


// GC_Perk_FourOnTheFloor_MainDrums_C GC_Perk_FourOnTheFloor_MainDrums.Default__GC_Perk_FourOnTheFloor_MainDrums_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_Perk_FourOnTheFloor_MainDrums_C* AGC_Perk_FourOnTheFloor_MainDrums_C::GetDefaultObj()
{
	static class AGC_Perk_FourOnTheFloor_MainDrums_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_Perk_FourOnTheFloor_MainDrums_C*>(AGC_Perk_FourOnTheFloor_MainDrums_C::StaticClass()->DefaultObject);
