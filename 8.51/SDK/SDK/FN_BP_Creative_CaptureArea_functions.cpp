...
class UClass* ABP_Creative_CaptureArea_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Creative_CaptureArea_C");

	return Clss;
}


// BP_Creative_CaptureArea_C BP_Creative_CaptureArea.Default__BP_Creative_CaptureArea_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Creative_CaptureArea_C* ABP_Creative_CaptureArea_C::GetDefaultObj()
{
	static class ABP_Creative_CaptureArea_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Creative_CaptureArea_C*>(ABP_Creative_CaptureArea_C::StaticClass()->DefaultObject);
