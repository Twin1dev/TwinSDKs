...
class UClass* UGCN_MistBlasterRangedImpact_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_MistBlasterRangedImpact_C");

	return Clss;
}


// GCN_MistBlasterRangedImpact_C GCN_MistBlasterRangedImpact.Default__GCN_MistBlasterRangedImpact_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_MistBlasterRangedImpact_C* UGCN_MistBlasterRangedImpact_C::GetDefaultObj()
{
	static class UGCN_MistBlasterRangedImpact_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_MistBlasterRangedImpact_C*>(UGCN_MistBlasterRangedImpact_C::StaticClass()->DefaultObject);
