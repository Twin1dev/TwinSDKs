...
public:
	...
	class UCommonActionWidget*                   Action_ActionDisplay;                              // 0x338(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UDynamicEntryBox*                      ChoicesEntryBox;                                   // 0x340(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonHierarchicalScrollBox*          ChoicesScrollBox;                                  // 0x348(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UButton*                               DummyButton;                                       // 0x350(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTextBlock*                      SelectionCountTextBlock;                           // 0x358(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	class UCommonTextBlock*                      Text_ActionDisplay;                                // 0x360(0x8)(BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData, RepSkip, NoDestructor, PersistentInstance, HasGetValueTypeHash)
	TArray<class UCommonButton*>                 ChoiceButtons;                                     // 0x368(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference)
	class FText                                  Text_Subtitle;                                     // 0x378(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  Text_SelectionCount_NoLimit;                       // 0x390(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  Text_SelectionCount_MinLimit;                      // 0x3A8(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  Text_SelectionCount_MaxLimit;                      // 0x3C0(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class UClass*                                SelectionCountStyle_Valid;                         // 0x3D8(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UClass*                                SelectionCountStyle_Invalid;                       // 0x3E0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  Text_ActionDisplay_ToggleOff;                      // 0x3E8(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class FText                                  Text_ActionDisplay_ToggleOn;                       // 0x400(0x18)(Edit, BlueprintVisible, DisableEditOnInstance)
	class UClass*                                ActionDisplayStyle_CannotToggle;                   // 0x418(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UClass*                                ActionDisplayStyle_CanToggle;                      // 0x420(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
