...
{
public:
	TArray<class USceneComponent*>               Array;                                             // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
...
{
public:
	TMap<class USceneComponent*, enum class ECollisionEnabled> Collision_Overrides;                               // 0x0(0x50)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, ContainsInstancedReference)
	TArray<class USceneComponent*>               CallFunc_Map_Keys_Keys;                            // 0x50(0x10)(ZeroConstructor, ReferenceParm, ContainsInstancedReference)
};
...
{
public:
	TArray<class USceneComponent*>               Scene_Components;                                  // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
	TArray<enum class ECollisionEnabled>         Local_Collision_List;                              // 0x10(0x10)(Edit, BlueprintVisible, ZeroConstructor)
};
...
public:
	...
	uint8                                        Pad_5D6D[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	TArray<class USceneComponent*>               CallFunc_Get_Visibility_Components_Components;     // 0x0(0x10)(ZeroConstructor, ReferenceParm, ContainsInstancedReference)
};
