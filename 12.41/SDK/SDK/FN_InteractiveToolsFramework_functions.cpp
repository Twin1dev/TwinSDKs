...
class UClass* UMeshSurfacePointToolMouseBehavior::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("MeshSurfacePointToolMouseBehavior");

	return Clss;
}


// MeshSurfacePointToolMouseBehavior InteractiveToolsFramework.Default__MeshSurfacePointToolMouseBehavior
// (Public, ClassDefaultObject, ArchetypeObject)

class UMeshSurfacePointToolMouseBehavior* UMeshSurfacePointToolMouseBehavior::GetDefaultObj()
{
	static class UMeshSurfacePointToolMouseBehavior* Default = nullptr;

	if (!Default)
		Default = static_cast<UMeshSurfacePointToolMouseBehavior*>(UMeshSurfacePointToolMouseBehavior::StaticClass()->DefaultObject);
