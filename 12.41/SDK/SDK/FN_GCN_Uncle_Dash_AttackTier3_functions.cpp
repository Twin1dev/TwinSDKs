...
// BlueprintGeneratedClass GCN_Uncle_Dash_AttackTier3.GCN_Uncle_Dash_AttackTier3_C
// (None)

class UClass* UGCN_Uncle_Dash_AttackTier3_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Uncle_Dash_AttackTier3_C");

	return Clss;
}


// GCN_Uncle_Dash_AttackTier3_C GCN_Uncle_Dash_AttackTier3.Default__GCN_Uncle_Dash_AttackTier3_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Uncle_Dash_AttackTier3_C* UGCN_Uncle_Dash_AttackTier3_C::GetDefaultObj()
{
	static class UGCN_Uncle_Dash_AttackTier3_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Uncle_Dash_AttackTier3_C*>(UGCN_Uncle_Dash_AttackTier3_C::StaticClass()->DefaultObject);
