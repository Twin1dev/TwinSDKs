...
public:
	...
	uint8                                        Pad_1724[0x67];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TArray<struct FVectorParameterNameAndCurves> Vectors;                                           // 0x30(0x10)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FColorParameterNameAndCurves>  Colors;                                            // 0x40(0x10)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FTransformParameterNameAndCurves> Transforms;                                        // 0x50(0x10)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
};
...
public:
	...
	uint8                                        Pad_173D[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1740[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1746[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	struct FFrameNumber                          Time;                                              // 0x14(0x4)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1749[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	struct FVector                               Location;                                          // 0x8(0xC)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FFrameNumber                          Time;                                              // 0x14(0x4)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_174A[0x18];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1761[0x28];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1767[0x4];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_176E[0xF];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	TSubclassOf<class UCameraShake>              ShakeClass;                                        // 0x0(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	enum class ECameraAnimPlaySpace              Playspace;                                         // 0xC(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_1776[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1779[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	FFieldPathProperty_                          BoundObjectProperty;                               // 0x8(0x20)(NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_178D[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1793[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1798[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TArray<struct FMovieSceneEventPtrs>          Events;                                            // 0x48(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_17AA[0x1C];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
