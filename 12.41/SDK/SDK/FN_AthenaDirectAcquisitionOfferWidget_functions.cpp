...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// TSoftObjectPtr<class UMaterialInterface>CallFunc_GetFirstOfferSeriesBackgroundMaterial_ReturnValue       (HasGetValueTypeHash)
...
void UAthenaDirectAcquisitionOfferWidget_C::UpdateStyle(TSoftObjectPtr<class UMaterialInterface> CallFunc_GetFirstOfferSeriesBackgroundMaterial_ReturnValue, bool CallFunc_IsValidSoftObjectReference_ReturnValue, TSoftObjectPtr<class UTexture2D> CallFunc_GetFirstOfferSeriesBackgroundTexture_ReturnValue, bool CallFunc_IsValidSoftObjectReference_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
	...
	Parms.CallFunc_GetFirstOfferSeriesBackgroundMaterial_ReturnValue = CallFunc_GetFirstOfferSeriesBackgroundMaterial_ReturnValue;
