...
// TArray<struct FLinearColor>        K2Node_MakeArray_Array                                           (ZeroConstructor, ReferenceParm)
// class FString                      CallFunc_Conv_IntToString_ReturnValue                            (ZeroConstructor, HasGetValueTypeHash)
// class FName                        CallFunc_Conv_StringToName_ReturnValue                           (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FHomebaseRatingDifficultyMappingDataCallFunc_GetDataTableRowFromName_OutRow                          (None)
...
void UStyleLibrary_C::Get_Conning_Color_From_Homebase_Rating(int32 HomeBaseRating, int32 DifficultyLevel, class UObject* __WorldContext, struct FLinearColor* DifficultyColor, int32 NewLocalVar_0, const TArray<struct FLinearColor>& DifficultyColors, TArray<struct FLinearColor>& K2Node_MakeArray_Array, const class FString& CallFunc_Conv_IntToString_ReturnValue, class FName CallFunc_Conv_StringToName_ReturnValue, const struct FHomebaseRatingDifficultyMappingData& CallFunc_GetDataTableRowFromName_OutRow, bool CallFunc_GetDataTableRowFromName_ReturnValue, const struct FLinearColor& CallFunc_Array_Get_Item, int32 CallFunc_Subtract_IntInt_ReturnValue, const struct FLinearColor& CallFunc_Array_Get_Item_1, bool CallFunc_InRange_IntInt_ReturnValue, bool CallFunc_InRange_IntInt_ReturnValue_1, bool CallFunc_InRange_IntInt_ReturnValue_2, bool CallFunc_InRange_IntInt_ReturnValue_3, const struct FLinearColor& CallFunc_Array_Get_Item_2, const struct FLinearColor& CallFunc_Array_Get_Item_3, const struct FLinearColor& CallFunc_Array_Get_Item_4)
{
	...
	if (!Func)
		Func = Class->GetFunction("StyleLibrary_C", "Get Conning Color From Homebase Rating");

	Params::UStyleLibrary_C_Get_Conning_Color_From_Homebase_Rating_Params Parms{};
...
void UStyleLibrary_C::Get_Item_Size(const struct FFortUIStylesheet& StyleSheet, enum class EFortBrushSize Brush_Size, class UObject* __WorldContext, struct FVector2D* Item_Size, const struct FVector2D& CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UStyleLibrary_C::Get_Item_Icon_Size(const struct FFortUIStylesheet& StyleSheet, enum class EFortBrushSize Brush_Size, class UObject* __WorldContext, struct FVector2D* Icon_Size, const struct FVector2D& CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UStyleLibrary_C::Get_Standard_Icon_Size(const struct FFortUIStylesheet& StyleSheet, enum class EFortBrushSize Brush_Size, class UObject* __WorldContext, struct FVector2D* Icon_Size, const struct FVector2D& CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue)
{
	static class UFunction* Func = nullptr;
