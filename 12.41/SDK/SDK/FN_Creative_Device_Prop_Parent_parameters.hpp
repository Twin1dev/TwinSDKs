...
{
public:
	TMap<class USceneComponent*, enum class ECollisionEnabled> VisibilityComponents;                              // 0x0(0x50)(Parm, OutParm, ZeroConstructor, ContainsInstancedReference)
	TMap<class USceneComponent*, enum class ECollisionEnabled> K2Node_MakeMap_Map;                                // 0x50(0x50)(ZeroConstructor, ContainsInstancedReference)
};
...
{
public:
	TArray<class USceneComponent*>               VisibilityComponents;                              // 0x0(0x10)(Parm, OutParm, ZeroConstructor, ContainsInstancedReference)
	TArray<class USceneComponent*>               K2Node_MakeArray_Array;                            // 0x10(0x10)(ZeroConstructor, ReferenceParm, ContainsInstancedReference)
};
...
public:
	...
	TArray<class USceneComponent*>               CallFunc_GetVisibilityComponents_VisibilityComponents; // 0x58(0x10)(ZeroConstructor, ReferenceParm, ContainsInstancedReference)
	TMap<class USceneComponent*, enum class ECollisionEnabled> CallFunc_GetVisibilityComponentsWithCollisionOverrides_VisibilityComponents; // 0x68(0x50)(ZeroConstructor, ContainsInstancedReference)
};
