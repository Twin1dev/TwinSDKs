...
public:
	...
	TArray<struct FWaterWaveParams>              CallFunc_Generate_Spectrum_Waves;                  // 0x28(0x10)(ZeroConstructor, ReferenceParm)
...
public:
	...
	TArray<class ALandscapeWaterInfo_C*>         CallFunc_GetAllActorsOfClass_OutActors;            // 0x178(0x10)(ZeroConstructor, ReferenceParm)
	...
	uint8                                        Pad_60A7[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
