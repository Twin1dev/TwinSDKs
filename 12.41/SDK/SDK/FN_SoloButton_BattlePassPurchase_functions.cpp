...
class UClass* USoloButton_BattlePassPurchase_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("SoloButton_BattlePassPurchase_C");

	return Clss;
}


// SoloButton_BattlePassPurchase_C SoloButton_BattlePassPurchase.Default__SoloButton_BattlePassPurchase_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class USoloButton_BattlePassPurchase_C* USoloButton_BattlePassPurchase_C::GetDefaultObj()
{
	static class USoloButton_BattlePassPurchase_C* Default = nullptr;

	if (!Default)
		Default = static_cast<USoloButton_BattlePassPurchase_C*>(USoloButton_BattlePassPurchase_C::StaticClass()->DefaultObject);
...
void USoloButton_BattlePassPurchase_C::SetText(class FText Text)
{
	...
	Params::USoloButton_BattlePassPurchase_C_SetText_Params Parms{};
...
void USoloButton_BattlePassPurchase_C::HandleSize(bool Temp_bool_Variable, bool Temp_bool_Variable_1, int32 Temp_int_Variable, const struct FMargin& K2Node_MakeStruct_Margin, const struct FMargin& K2Node_Select_Default, int32 K2Node_Select_Default_1, const struct FSlateFontInfo& K2Node_MakeStruct_SlateFontInfo)
{
	...
	Params::USoloButton_BattlePassPurchase_C_HandleSize_Params Parms{};
...
void USoloButton_BattlePassPurchase_C::PreConstruct(bool IsDesignTime)
{
	...
	Params::USoloButton_BattlePassPurchase_C_PreConstruct_Params Parms{};
...
void USoloButton_BattlePassPurchase_C::ExecuteUbergraph_SoloButton_BattlePassPurchase(int32 EntryPoint, bool Temp_bool_Variable, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, float Temp_float_Variable, float Temp_float_Variable_1, bool K2Node_Event_IsDesignTime, class UUMGSequencePlayer* CallFunc_PlayAnimationForward_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimationReverse_ReturnValue, class UCommonInputSubsystem* CallFunc_GetContext_ReturnValue, enum class ECommonInputType CallFunc_GetCurrentInputType_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, float K2Node_Select_Default)
{
	...
	Params::USoloButton_BattlePassPurchase_C_ExecuteUbergraph_SoloButton_BattlePassPurchase_Params Parms{};
