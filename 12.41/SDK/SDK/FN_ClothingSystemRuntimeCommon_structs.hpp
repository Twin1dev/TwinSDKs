...
public:
	...
	TMap<uint32, struct FPointWeightMap>         WeightMaps;                                        // 0x30(0x50)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_284B[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
