...
public:
	...
	uint8                                        Pad_6C4D[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	struct FMcpVariantChannelInfo                CallFunc_Array_Get_Item;                           // 0xB0(0x48)(None)
	...
	struct FUnlockableVariantPreviewInfo         K2Node_MakeStruct_UnlockableVariantPreviewInfo;    // 0x100(0x28)(None)
};
...
public:
	...
	uint8                                        Pad_6C58[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
