...
void UCreative_CommonDeviceFunctionLibrary_C::GetMinigameSettingsMachineForMinigame(class AFortMinigame* Minigame, class UObject* __WorldContext, class AMinigameSettingsMachine_C** MinigameSettingsMachine, class AFortMinigameSettingsBuilding* CallFunc_GetSettingsActorForVolume_ReturnValue, class AMinigameSettingsMachine_C* K2Node_DynamicCast_AsMinigame_Settings_Machine, bool K2Node_DynamicCast_bSuccess)
{
	...
	if (!Func)
		Func = Class->GetFunction("Creative_CommonDeviceFunctionLibrary_C", "GetMinigameSettingsMachineForMinigame");

	Params::UCreative_CommonDeviceFunctionLibrary_C_GetMinigameSettingsMachineForMinigame_Params Parms{};
