...
public:
	...
	TArray<struct FVector>                       CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplinePoints; // 0x178(0x10)(ZeroConstructor, ReferenceParm)
	TArray<struct FVector>                       CallFunc_CalculateProjectileTrajectorySplineWithHit_OutSplineTangents; // 0x188(0x10)(ZeroConstructor, ReferenceParm)
};
...
public:
	...
	class USphereComponent*                      K2Node_DynamicCast_AsSphere_Collision;             // 0x108(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AB_HeldObjectSocket_C*                 K2Node_DynamicCast_AsB_Held_Object_Socket;         // 0x118(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	class AB_HeldObject_Parent_C*                CallFunc_ValidateHeldObject_HeldObject_Output;     // 0x128(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_ValidateHeldObject_IsValid;               // 0x130(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
...
public:
	class AFortPlayerPawn*                       CallFunc_GetOwningPlayer_Player_Pawn;              // 0x0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_474B[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            CallFunc_GetTransform_ReturnValue;                 // 0x10(0x30)(ConstParm, IsPlainOldData, NoDestructor)
...
public:
	...
	TArray<class AActor*>                        CallFunc_FilterArray_FilteredArray;                // 0x20(0x10)(ZeroConstructor, ReferenceParm)
