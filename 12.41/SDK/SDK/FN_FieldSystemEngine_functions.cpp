...
class UOperatorField* UOperatorField::SetOperatorField(float Magnitude, class UFieldNodeBase* RightField, class UFieldNodeBase* LeftField, enum class EFieldOperationType Operation)
{
	static class UFunction* Func = nullptr;
