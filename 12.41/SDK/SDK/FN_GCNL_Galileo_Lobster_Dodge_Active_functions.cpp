...
class UClass* AGCNL_Galileo_Lobster_Dodge_Active_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCNL_Galileo_Lobster_Dodge_Active_C");

	return Clss;
}


// GCNL_Galileo_Lobster_Dodge_Active_C GCNL_Galileo_Lobster_Dodge_Active.Default__GCNL_Galileo_Lobster_Dodge_Active_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGCNL_Galileo_Lobster_Dodge_Active_C* AGCNL_Galileo_Lobster_Dodge_Active_C::GetDefaultObj()
{
	static class AGCNL_Galileo_Lobster_Dodge_Active_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGCNL_Galileo_Lobster_Dodge_Active_C*>(AGCNL_Galileo_Lobster_Dodge_Active_C::StaticClass()->DefaultObject);
