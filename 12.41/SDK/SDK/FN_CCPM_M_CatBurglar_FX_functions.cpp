...
class UClass* ACCPM_M_CatBurglar_FX_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CCPM_M_CatBurglar_FX_C");

	return Clss;
}


// CCPM_M_CatBurglar_FX_C CCPM_M_CatBurglar_FX.Default__CCPM_M_CatBurglar_FX_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ACCPM_M_CatBurglar_FX_C* ACCPM_M_CatBurglar_FX_C::GetDefaultObj()
{
	static class ACCPM_M_CatBurglar_FX_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ACCPM_M_CatBurglar_FX_C*>(ACCPM_M_CatBurglar_FX_C::StaticClass()->DefaultObject);
