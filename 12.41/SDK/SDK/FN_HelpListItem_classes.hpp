...
public:
	...
	FMulticastInlineDelegateProperty_            InviteJoinChanged;                                 // 0xBB8(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
