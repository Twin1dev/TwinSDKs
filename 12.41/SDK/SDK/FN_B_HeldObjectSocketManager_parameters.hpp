...
{
public:
	TArray<struct FGameplayTagContainer>         CorrectTags;                                       // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
	TArray<struct FGameplayTagContainer>         CurrentTags;                                       // 0x10(0x10)(BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ZeroConstructor, ReferenceParm)
	...
	uint8                                        Pad_5A04[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
