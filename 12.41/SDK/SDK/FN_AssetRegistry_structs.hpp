...
public:
	...
	uint8                                        Pad_36D8[0x50];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	TSet<class FName>                            RecursiveClassesExclusionSet;                      // 0x90(0x50)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_36D9[0x5];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_36DA[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
