...
class UClass* UGCN_Uncle_Dash_AttackTier1_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Uncle_Dash_AttackTier1_C");

	return Clss;
}


// GCN_Uncle_Dash_AttackTier1_C GCN_Uncle_Dash_AttackTier1.Default__GCN_Uncle_Dash_AttackTier1_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Uncle_Dash_AttackTier1_C* UGCN_Uncle_Dash_AttackTier1_C::GetDefaultObj()
{
	static class UGCN_Uncle_Dash_AttackTier1_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Uncle_Dash_AttackTier1_C*>(UGCN_Uncle_Dash_AttackTier1_C::StaticClass()->DefaultObject);
