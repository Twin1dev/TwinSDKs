...
public:
	...
	TArray<class USceneComponent*>               VisibleSceneComponents;                            // 0xD0(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference)
	...
	TMap<class USceneComponent*, enum class ECollisionEnabled> Collision_Enabled_Overrides;                       // 0xF0(0x50)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference)
