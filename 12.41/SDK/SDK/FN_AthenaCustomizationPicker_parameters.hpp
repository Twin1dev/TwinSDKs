...
public:
	...
	uint8                                        Pad_6BF1[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	FDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate;              // 0x8(0x10)(ZeroConstructor, NoDestructor)
	FDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate_1;            // 0x18(0x10)(ZeroConstructor, NoDestructor)
	class FText                                  CallFunc_GetQualifiedFilterDisplayName_ReturnValue; // 0x28(0x18)(None)
	class FText                                  K2Node_Event_EmptyDisplayText;                     // 0x40(0x18)(ConstParm)
	bool                                         K2Node_Event_bEnabled;                             // 0x58(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class FText                                  K2Node_CustomEvent_Text_1;                         // 0x60(0x18)(ConstParm)
	...
	class FText                                  K2Node_CustomEvent_Text;                           // 0x80(0x18)(ConstParm)
	enum class ETextCommit                       K2Node_CustomEvent_CommitMethod;                   // 0x98(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
