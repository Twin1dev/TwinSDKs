...
{
public:
	uint8                                        Pad_18E0[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_191D[0x10];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1922[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        BitPad_114 : 5;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
...
{
public:
	FMulticastInlineDelegateProperty_            OnCameraCut;                                       // 0x870(0x10)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                        Pad_1942[0x108];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	class ALevelSequenceActor*                   Sequence;                                          // 0x220(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	class UMediaComponent*                       MediaComponent;                                    // 0x228(0x8)(Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	float                                        ServerStartTimeSeconds;                            // 0x230(0x4)(BlueprintVisible, BlueprintReadOnly, Net, ZeroConstructor, IsPlainOldData, RepNotify, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_194D[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
