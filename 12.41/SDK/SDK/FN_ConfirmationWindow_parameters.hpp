...
public:
	...
	struct FFortDialogDescription_NUI            CallFunc_GetConfirmationDescription_ReturnValue;   // 0x10(0x118)(ConstParm, ContainsInstancedReference)
	class UCommonButton*                         K2Node_Event_Button;                               // 0x128(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
