...
class UClass* UFloatingInteraction_Indicator_Dailies_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("FloatingInteraction_Indicator_Dailies_C");

	return Clss;
}


// FloatingInteraction_Indicator_Dailies_C FloatingInteraction_Indicator_Dailies.Default__FloatingInteraction_Indicator_Dailies_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UFloatingInteraction_Indicator_Dailies_C* UFloatingInteraction_Indicator_Dailies_C::GetDefaultObj()
{
	static class UFloatingInteraction_Indicator_Dailies_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UFloatingInteraction_Indicator_Dailies_C*>(UFloatingInteraction_Indicator_Dailies_C::StaticClass()->DefaultObject);
