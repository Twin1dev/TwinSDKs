...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::UpdateTileViewSize(class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue)
{
	...
	Params::UAthenaDirectAcquisitionOfferDetailsWidget_C_UpdateTileViewSize_Params Parms{};
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::SetupAffiliate(enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, bool Temp_bool_Variable, enum class ESubGame CallFunc_GetCurrentSubGame_ReturnValue, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, const class FString& CallFunc_GetAffiliateName_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, class FText CallFunc_Conv_StringToText_ReturnValue, int32 CallFunc_Len_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
	...
	Params::UAthenaDirectAcquisitionOfferDetailsWidget_C_SetupAffiliate_Params Parms{};
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::ShowSwipeButtons(FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::ExecutePurchase(FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate)
{
	static class UFunction* Func = nullptr;
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::BndEvt__CloseButton_K2Node_ComponentBoundEvent_6_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	...
	Params::UAthenaDirectAcquisitionOfferDetailsWidget_C_BndEvt__CloseButton_K2Node_ComponentBoundEvent_6_CommonButtonClicked__DelegateSignature_Params Parms{};
...
void UAthenaDirectAcquisitionOfferDetailsWidget_C::ExecuteUbergraph_AthenaDirectAcquisitionOfferDetailsWidget(int32 EntryPoint, class UCommonButton* K2Node_ComponentBoundEvent_Button_8, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_Subtract_IntInt_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1, class UCommonButton* K2Node_ComponentBoundEvent_Button_7, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, int32 CallFunc_Array_Find_ReturnValue, bool CallFunc_Greater_IntInt_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue_1, int32 CallFunc_Array_Length_ReturnValue_1, int32 CallFunc_Percent_IntInt_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button_6, class UFortStoreFrontOfferInfo* CallFunc_Array_Get_Item, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue_1, int32 CallFunc_Array_Length_ReturnValue_2, int32 CallFunc_Array_Find_ReturnValue_1, bool CallFunc_Greater_IntInt_ReturnValue_1, int32 CallFunc_Subtract_IntInt_ReturnValue_1, class UFortStoreFrontOfferInfo* CallFunc_Array_Get_Item_1, bool CallFunc_GreaterEqual_IntInt_ReturnValue, int32 CallFunc_Array_LastIndex_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_Array_Get_Item_2, int32 Temp_int_Variable, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button_5, bool CallFunc_HandleBack_PassThrough, class UHorizontalBoxSlot* CallFunc_SlotAsHorizontalBoxSlot_ReturnValue, class UHorizontalBoxSlot* CallFunc_SlotAsHorizontalBoxSlot_ReturnValue_1, int32 Temp_int_Variable_1, class UFortItem* K2Node_CustomEvent_Item, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsMobileGame_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue_2, int32 CallFunc_GetNumGrantedItems_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button_4, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue_3, bool CallFunc_IsMobileGame_ReturnValue_1, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue_4, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue_1, enum class EOfferPurchaseError CallFunc_CanGiftOffer_Result, enum class ESlateVisibility Temp_byte_Variable, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, float CallFunc_GetDelayGiftButtonWhenMFANotEnabledSeconds_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button_3, class UCommonButton* K2Node_ComponentBoundEvent_Button_2, const struct FMargin& CallFunc_GetOfferDetailsSlotMargin_Margin, enum class ESlateVisibility Temp_byte_Variable_1, bool CallFunc_IsActivated_ReturnValue, bool Temp_bool_Variable, class UFortItemDefinition* CallFunc_GetItemDefinition_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue_2, const struct FUnlockableVariantPreviewInfo& K2Node_MakeStruct_UnlockableVariantPreviewInfo, class UCommonButton* K2Node_ComponentBoundEvent_Button_1, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue_3, bool CallFunc_HandleUndoAction_PassThrough, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, enum class ESubGame CallFunc_GetCurrentSubGame_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3, bool CallFunc_EqualEqual_ByteByte_ReturnValue_1, const struct FTimerHandle& CallFunc_K2_SetTimerDelegate_ReturnValue, enum class ESlateVisibility K2Node_Select_Default, class UUserWidget* K2Node_ComponentBoundEvent_Widget, class UAthenaDirectAquisitionStyleScreen_C* CallFunc_CreateDirectAcquisitionStyleScreenWidget_Instance, class UGiftingScreen_C* CallFunc_CreateGiftingScreenWidget_Instance, class UEnableMultiFactorAuthModalBP_C* CallFunc_Create2FAWidget_Instance, bool CallFunc_QueueModal_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue_4, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue_5, bool CallFunc_HasMfaBeenEnabledAtSomePoint_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue_6, class UCommonButton* K2Node_ComponentBoundEvent_Button, const struct FUnlockableVariantPreviewInfo& K2Node_MakeStruct_UnlockableVariantPreviewInfo_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_4)
{
	static class UFunction* Func = nullptr;
