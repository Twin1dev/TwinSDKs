...
public:
	...
	uint8                                        Pad_22A1[0x20];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_22F1[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_22F5[0x17];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_22FD[0x4C8];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	uint8                                        BitPad_186 : 1;                                    // Fixing Bit-Field Size  [ Dumper-7 ]
...
{
public:
	enum class ESOReferenceDrawingMode           ReferenceDrawingMode;                              // 0x3E8(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
