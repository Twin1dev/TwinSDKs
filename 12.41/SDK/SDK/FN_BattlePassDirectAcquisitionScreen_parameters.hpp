...
struct UBattlePassDirectAcquisitionScreen_C_BndEvt__CloseButton_K2Node_ComponentBoundEvent_1_CommonButtonClicked__DelegateSignature_Params
{
public:
	class UCommonButton*                         Button;                                            // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	struct FDateTime                             CallFunc_GetSeasonStoreEndDate_ReturnValue;        // 0x40(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class FText                                  CallFunc_GetSeasonEndLabelText_Result;             // 0x50(0x18)(None)
	bool                                         CallFunc_HandleBack_bPassThrough;                  // 0x68(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
