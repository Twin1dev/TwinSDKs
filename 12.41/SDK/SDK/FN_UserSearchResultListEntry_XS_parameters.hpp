...
public:
	...
	bool                                         K2Node_ComponentBoundEvent_bIsOpen;                // 0xB9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	bool                                         CallFunc_IsAnimationPlaying_ReturnValue;           // 0xD8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_50D1[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class UUMGSequencePlayer*                    CallFunc_PlayAnimation_ReturnValue_3;              // 0xE0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  K2Node_Event_DisplayName;                          // 0xE8(0x18)(ConstParm)
	class FText                                  K2Node_Event_Platform;                             // 0x100(0x18)(ConstParm)
	int32                                        K2Node_Event_MutualCount;                          // 0x118(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_EqualEqual_IgnoreCase_TextText_ReturnValue; // 0x139(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
