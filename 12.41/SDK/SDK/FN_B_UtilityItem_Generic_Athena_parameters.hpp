...
public:
	...
	TArray<struct FWeaponHudKeyActionVisibility> K2Node_MakeArray_Array;                            // 0x28(0x10)(ConstParm, ZeroConstructor, ReferenceParm)
	...
	TArray<struct FWeaponHudKeyActionVisibility> K2Node_MakeArray_Array_1;                          // 0x50(0x10)(ConstParm, ZeroConstructor, ReferenceParm)
	struct FWeaponHudKeyActionVisibility         K2Node_MakeStruct_WeaponHudKeyActionVisibility_7;  // 0x60(0x8)(NoDestructor)
	TArray<struct FWeaponHudKeyActionVisibility> K2Node_MakeArray_Array_2;                          // 0x68(0x10)(ConstParm, ZeroConstructor, ReferenceParm)
	struct FWeaponHudKeyActionVisibility         K2Node_MakeStruct_WeaponHudKeyActionVisibility_8;  // 0x78(0x8)(NoDestructor)
	TArray<struct FWeaponHudKeyActionVisibility> K2Node_MakeArray_Array_3;                          // 0x80(0x10)(ConstParm, ZeroConstructor, ReferenceParm)
};
