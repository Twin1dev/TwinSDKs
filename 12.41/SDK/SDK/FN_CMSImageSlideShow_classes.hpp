...
public:
	...
	FMulticastInlineDelegateProperty_            CarouselIndexChanged;                              // 0x248(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
