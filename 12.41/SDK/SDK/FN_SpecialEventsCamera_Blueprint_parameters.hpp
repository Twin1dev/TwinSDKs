...
public:
	...
	TArray<class ATVPostProcessBP_C*>            CallFunc_GetAllActorsOfClass_OutActors_1;          // 0x50(0x10)(ZeroConstructor, ReferenceParm)
	...
	TArray<class ABP_FortniteLobbyLightSwitcher_C*> CallFunc_GetAllActorsOfClass_OutActors_2;          // 0x90(0x10)(ZeroConstructor, ReferenceParm)
