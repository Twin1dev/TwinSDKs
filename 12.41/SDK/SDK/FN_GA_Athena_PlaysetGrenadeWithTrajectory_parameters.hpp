...
public:
	...
	struct FHitResult                            CallFunc_CalculateProjectileTrajectorySplineWithHit_OutHitResult; // 0x4C(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	uint8                                        Pad_5FD8[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_5FD9[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
