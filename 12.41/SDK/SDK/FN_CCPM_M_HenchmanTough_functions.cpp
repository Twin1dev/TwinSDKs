...
class UClass* ACCPM_M_HenchmanTough_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CCPM_M_HenchmanTough_C");

	return Clss;
}


// CCPM_M_HenchmanTough_C CCPM_M_HenchmanTough.Default__CCPM_M_HenchmanTough_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ACCPM_M_HenchmanTough_C* ACCPM_M_HenchmanTough_C::GetDefaultObj()
{
	static class ACCPM_M_HenchmanTough_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ACCPM_M_HenchmanTough_C*>(ACCPM_M_HenchmanTough_C::StaticClass()->DefaultObject);
