...
public:
	...
	TArray<class FName>                          CallFunc_Map_Values_Values;                        // 0x30(0x10)(ZeroConstructor, ReferenceParm)
	...
	TArray<class FName>                          CallFunc_Map_Values_Values_1;                      // 0x90(0x10)(ZeroConstructor, ReferenceParm)
...
public:
	...
	TArray<enum class En_ShellTypes_01>          Keys_to_Check;                                     // 0x8(0x10)(Edit, BlueprintVisible, ZeroConstructor)
	TArray<class FName>                          Values_to_Run_Through;                             // 0x18(0x10)(Edit, BlueprintVisible, ZeroConstructor)
	...
	uint8                                        Pad_5566[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	TArray<enum class En_ShellTypes_01>          CallFunc_Map_Keys_Keys;                            // 0x30(0x10)(ZeroConstructor, ReferenceParm)
	TArray<class FName>                          CallFunc_Map_Values_Values;                        // 0x40(0x10)(ZeroConstructor, ReferenceParm)
...
public:
	...
	uint8                                        Pad_5589[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	TArray<class AFortAIPawn*>                   CallFunc_GetAllActorsOfClass_OutActors;            // 0x18(0x10)(ZeroConstructor, ReferenceParm)
	...
	uint8                                        Pad_55B0[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_55B2[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
