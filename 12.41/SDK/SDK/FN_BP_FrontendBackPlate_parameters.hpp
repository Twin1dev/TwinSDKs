...
public:
	...
	TArray<class AActor*>                        CallFunc_GetAllActorsWithTag_OutActors;            // 0x30(0x10)(ZeroConstructor, ReferenceParm)
	...
	TArray<class AActor*>                        CallFunc_SortActorArray_OutSortedActors;           // 0x48(0x10)(ZeroConstructor, ReferenceParm)
	class FString                                CallFunc_CreateUniqueMaterialName_UniqueString_2;  // 0x58(0x10)(ZeroConstructor, HasGetValueTypeHash)
