...
public:
	...
	FDelegateProperty_                           K2Node_CreateDelegate_OutputDelegate_3;            // 0x288(0x10)(ZeroConstructor, NoDestructor)
	float                                        K2Node_Event_DeltaSeconds;                         // 0x298(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class UParticleSystemComponent*>      K2Node_Event_ParticleComponents;                   // 0x428(0x10)(ConstParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
	TArray<class UAudioComponent*>               K2Node_Event_AudioComponents;                      // 0x438(0x10)(ConstParm, ZeroConstructor, ReferenceParm, ContainsInstancedReference)
