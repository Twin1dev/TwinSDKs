...
public:
	...
	struct FHitResult                            CallFunc_K2_SetWorldRotation_SweepHitResult;       // 0xD8(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                         Temp_bool_Option_B___If_false__use_Option_A_Variable; // 0x164(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
