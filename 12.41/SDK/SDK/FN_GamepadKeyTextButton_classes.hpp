...
public:
	...
	FMulticastInlineDelegateProperty_            ChangeTheBinding_Button;                           // 0xC68(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
