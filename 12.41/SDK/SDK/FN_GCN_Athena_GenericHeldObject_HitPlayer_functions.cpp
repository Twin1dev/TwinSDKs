...
class UClass* UGCN_Athena_GenericHeldObject_HitPlayer_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Athena_GenericHeldObject_HitPlayer_C");

	return Clss;
}


// GCN_Athena_GenericHeldObject_HitPlayer_C GCN_Athena_GenericHeldObject_HitPlayer.Default__GCN_Athena_GenericHeldObject_HitPlayer_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Athena_GenericHeldObject_HitPlayer_C* UGCN_Athena_GenericHeldObject_HitPlayer_C::GetDefaultObj()
{
	static class UGCN_Athena_GenericHeldObject_HitPlayer_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Athena_GenericHeldObject_HitPlayer_C*>(UGCN_Athena_GenericHeldObject_HitPlayer_C::StaticClass()->DefaultObject);
