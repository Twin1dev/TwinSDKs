...
public:
	...
	struct FHitResult                            CallFunc_K2_SetActorTransform_SweepHitResult;      // 0x90(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	bool                                         CallFunc_K2_SetActorTransform_ReturnValue;         // 0x11C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
};
...
public:
	...
	struct FHitResult                            CallFunc_K2_SetActorTransform_SweepHitResult;      // 0x34(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
