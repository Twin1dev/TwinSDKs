...
void UBladeMenu_MainMenu_C::UpdateCreativeButtonsVisibility(class AFortPlayerState* OwningPlayerState, class AFortVolume* Volume, class AFortGameStateAthena* Fort_Game_State_Athena, enum class ESlateVisibility Temp_byte_Variable, bool CallFunc_IsValid_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable_1, enum class ESlateVisibility Temp_byte_Variable_2, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, enum class ESlateVisibility Temp_byte_Variable_3, class AFortPlayerControllerGameplay* K2Node_DynamicCast_AsFort_Player_Controller_Gameplay, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsCreativeIslandExporterEnabled_ReturnValue, bool Temp_bool_Variable_1, class AFortMinigame* CallFunc_GetMinigameForVolume_ReturnValue, bool Temp_bool_Variable_2, bool CallFunc_IsCuratedHub_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_Not_PreBool_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_3, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, bool CallFunc_IsCreativeModePlaylist_ReturnValue, bool CallFunc_IsCreativeLTMPlaylist_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1, bool CallFunc_BooleanAND_ReturnValue_2, class AGameStateBase* CallFunc_GetGameState_ReturnValue, class AFortGameStateAthena* K2Node_DynamicCast_AsFort_Game_State_Athena, bool K2Node_DynamicCast_bSuccess_1, enum class ESlateVisibility Temp_byte_Variable_4, bool CallFunc_IsCreativeModePlaylist_ReturnValue_1, enum class ESlateVisibility Temp_byte_Variable_5, bool Temp_bool_Variable_3, bool CallFunc_IsValid_ReturnValue_4, enum class ESlateVisibility Temp_byte_Variable_6, bool CallFunc_IsTeleportToCreativeHubAllowed_ReturnValue, bool CallFunc_CanRespawnOnStarterIsland_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_3, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_1, class AFortPlayerControllerAthena* K2Node_DynamicCast_AsFort_Player_Controller_Athena, bool K2Node_DynamicCast_bSuccess_2, enum class ESlateVisibility K2Node_Select_Default, bool CallFunc_OwnsIslandVolume_ReturnValue, class AFortVolume* CallFunc_GetCurrentVolume_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_4, bool CallFunc_BooleanAND_ReturnValue_5, class APlayerController* CallFunc_GetPlayerController_ReturnValue, enum class ESlateVisibility K2Node_Select_Default_1, class AFortPlayerState* K2Node_DynamicCast_AsFort_Player_State, bool K2Node_DynamicCast_bSuccess_3, enum class ESlateVisibility Temp_byte_Variable_7, class APlayerController* CallFunc_GetPlayerController_ReturnValue_1, enum class ESlateVisibility K2Node_Select_Default_2, class AAthena_PlayerController_C* K2Node_DynamicCast_AsAthena_Player_Controller, bool K2Node_DynamicCast_bSuccess_4, bool CallFunc_ShowMinigameButtons_bResult, bool CallFunc_IsMoveInputIgnored_ReturnValue, enum class ESlateVisibility K2Node_Select_Default_3, class AGameStateBase* CallFunc_GetGameState_ReturnValue_1, class AFortGameStateAthena* K2Node_DynamicCast_AsFort_Game_State_Athena_1, bool K2Node_DynamicCast_bSuccess_5)
{
	static class UFunction* Func = nullptr;
...
void UBladeMenu_MainMenu_C::Handle_Low_Power_Mode(FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UAthenaHUDContext* CallFunc_GetContext_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
void UBladeMenu_MainMenu_C::OnComplete_1BFCCA9642A0481B2AC5C98C395D0901(class UUserWidget* UserWidget)
{
	...
	Params::UBladeMenu_MainMenu_C_OnComplete_1BFCCA9642A0481B2AC5C98C395D0901_Params Parms{};
...
void UBladeMenu_MainMenu_C::OnOpenSettings(class FName TabNameID, const class FString& SettingToSelect)
{
	...
	Parms.SettingToSelect = SettingToSelect;
...
void UBladeMenu_MainMenu_C::BndEvt__LockerButton_K2Node_ComponentBoundEvent_13_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	...
	Params::UBladeMenu_MainMenu_C_BndEvt__LockerButton_K2Node_ComponentBoundEvent_13_CommonButtonClicked__DelegateSignature_Params Parms{};
...
void UBladeMenu_MainMenu_C::BndEvt__ExportIslandButton_K2Node_ComponentBoundEvent_6_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	...
	Params::UBladeMenu_MainMenu_C_BndEvt__ExportIslandButton_K2Node_ComponentBoundEvent_6_CommonButtonClicked__DelegateSignature_Params Parms{};
...
// TSoftClassPtr<class UUserWidget>   K2Node_Select_Default_5                                          (HasGetValueTypeHash)
// enum class EFortDialogResult       Temp_byte_Variable_13                                            (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class APlayerController*           CallFunc_GetOwningPlayer_ReturnValue_17                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// class UFortRuntimeOptions*         CallFunc_GetRuntimeOptions_ReturnValue_10                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// enum class ESlateVisibility        K2Node_Select_Default_6                                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void UBladeMenu_MainMenu_C::ExecuteUbergraph_BladeMenu_MainMenu(int32 EntryPoint, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsInZone_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UUserWidget* K2Node_CustomEvent_UserWidget_15, class UUserWidget* Temp_object_Variable, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UUserWidget* K2Node_CustomEvent_UserWidget_14, class UUserWidget* Temp_object_Variable_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, class UUserWidget* K2Node_CustomEvent_UserWidget_13, class UUserWidget* Temp_object_Variable_2, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue_1, class UUserWidget* K2Node_CustomEvent_UserWidget_12, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_3, class UUserWidget* Temp_object_Variable_3, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_4, class UUserWidget* K2Node_CustomEvent_UserWidget_11, class UUserWidget* Temp_object_Variable_4, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_5, class UUserWidget* K2Node_CustomEvent_UserWidget_10, class UUserWidget* Temp_object_Variable_5, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_6, class UUserWidget* K2Node_CustomEvent_UserWidget_9, class UUserWidget* Temp_object_Variable_6, class UHUDLayoutToolContext* CallFunc_GetContext_ReturnValue_2, class UUserWidget* K2Node_CustomEvent_UserWidget_8, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_7, class UUserWidget* Temp_object_Variable_7, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_8, class UUserWidget* K2Node_CustomEvent_UserWidget_7, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_9, class UUserWidget* Temp_object_Variable_8, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_10, class UUserWidget* K2Node_CustomEvent_UserWidget_6, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_11, class UUserWidget* Temp_object_Variable_9, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_12, class UUserWidget* K2Node_CustomEvent_UserWidget_5, class UUserWidget* Temp_object_Variable_10, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue_3, bool Temp_bool_Variable_1, bool CallFunc_IsInZone_ReturnValue_1, enum class ESlateVisibility Temp_byte_Variable_2, bool CallFunc_Not_PreBool_ReturnValue, enum class ESlateVisibility Temp_byte_Variable_3, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_13, class UUserWidget* K2Node_CustomEvent_UserWidget_4, class UUserWidget* Temp_object_Variable_11, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_14, class UCommonActivatablePanel* K2Node_DynamicCast_AsCommon_Activatable_Panel, bool K2Node_DynamicCast_bSuccess, class UUserWidget* K2Node_CustomEvent_UserWidget_3, class UUserWidget* Temp_object_Variable_12, bool Temp_bool_Variable_2, enum class ESlateVisibility Temp_byte_Variable_4, enum class ESlateVisibility Temp_byte_Variable_5, class UUserWidget* K2Node_CustomEvent_UserWidget_2, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_15, class UUserWidget* Temp_object_Variable_13, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_16, class UUserWidget* K2Node_CustomEvent_UserWidget_1, class UUserWidget* Temp_object_Variable_14, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_17, class UUserWidget* K2Node_CustomEvent_UserWidget, class UUserWidget* Temp_object_Variable_15, bool Temp_bool_Variable_3, enum class ESlateVisibility Temp_byte_Variable_6, enum class ESlateVisibility Temp_byte_Variable_7, bool Temp_bool_Variable_4, bool Temp_bool_Variable_5, enum class ESlateVisibility Temp_byte_Variable_8, enum class ESlateVisibility Temp_byte_Variable_9, class FName Temp_name_Variable, class UCommonButton* K2Node_ComponentBoundEvent_Button_21, class UCommonButton* K2Node_ComponentBoundEvent_Button_20, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue_4, enum class ESlateVisibility Temp_byte_Variable_10, class UCommonButton* K2Node_ComponentBoundEvent_Button_19, enum class ESlateVisibility Temp_byte_Variable_11, class UCommonButton* K2Node_ComponentBoundEvent_Button_18, class UCommonButton* K2Node_ComponentBoundEvent_Button_17, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button_16, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button_15, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_1, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_2, bool CallFunc_GetIsPlayerReportingFlowEnabled_ReturnValue, bool Temp_bool_Variable_6, bool CallFunc_ShowWebURL_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button_14, enum class ESlateVisibility K2Node_Select_Default, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_1, class UCommonButton* K2Node_ComponentBoundEvent_Button_13, enum class EFortDialogResult K2Node_CustomEvent_Result, class FName K2Node_CustomEvent_ResultName, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_2, class UCommonButton* K2Node_ComponentBoundEvent_Button_12, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_3, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_18, class UCommonButton* K2Node_ComponentBoundEvent_Button_11, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_4, class UCommonButton* K2Node_ComponentBoundEvent_Button_10, class UCommonButton* K2Node_ComponentBoundEvent_Button_9, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_5, class UCommonButton* K2Node_ComponentBoundEvent_Button_8, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_6, class UCommonButton* K2Node_ComponentBoundEvent_Button_7, class UFortHUDContext* CallFunc_GetContext_ReturnValue_5, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_7, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_1, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_2, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_3, bool CallFunc_IsValid_ReturnValue_2, bool CallFunc_IsValid_ReturnValue_3, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_4, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_5, bool CallFunc_IsValid_ReturnValue_4, bool CallFunc_IsValid_ReturnValue_5, class AMinigameSettingsMachine_C* K2Node_DynamicCast_AsMinigame_Settings_Machine, bool K2Node_DynamicCast_bSuccess_1, bool CallFunc_IsValid_ReturnValue_6, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue_6, bool CallFunc_IsValid_ReturnValue_7, class AMinigameSettingsMachine_C* K2Node_DynamicCast_AsMinigame_Settings_Machine_1, bool K2Node_DynamicCast_bSuccess_2, bool CallFunc_IsValid_ReturnValue_8, class UFortFrontEndContext* CallFunc_GetContext_ReturnValue_7, class AFortMinigame* K2Node_CustomEvent_Minigame, enum class EFortMinigameState K2Node_CustomEvent_MinigameState, bool CallFunc_IsValid_ReturnValue_9, class AMinigameSettingsMachine_C* K2Node_DynamicCast_AsMinigame_Settings_Machine_2, bool K2Node_DynamicCast_bSuccess_3, class AFortMinigame* CallFunc_GetCurrentMinigame_Minigame, enum class EFortDialogResult Temp_byte_Variable_12, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_6, bool K2Node_SwitchEnum_CmpSuccess, bool CallFunc_IsValid_ReturnValue_10, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_8, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_7, bool CallFunc_IsValid_ReturnValue_11, class UCommonButton* K2Node_ComponentBoundEvent_Button_6, class UCommonButton* K2Node_ComponentBoundEvent_Button_5, class FName Temp_name_Variable_1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_9, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_10, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_8, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_3, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_IsValid_ReturnValue_12, enum class ESlateVisibility K2Node_Select_Default_1, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue_8, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_4, bool CallFunc_GetNewSettingsScreenEnabled_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_11, enum class ESlateVisibility K2Node_Select_Default_2, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_9, bool CallFunc_IsValid_ReturnValue_13, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, float CallFunc_PauseAnimation_ReturnValue, bool CallFunc_IsAnimationPlaying_ReturnValue, float CallFunc_GetEndTime_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_1, float CallFunc_PauseAnimation_ReturnValue_1, bool CallFunc_IsAnimationPlaying_ReturnValue_1, float CallFunc_Subtract_FloatFloat_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_2, float CallFunc_GetEndTime_ReturnValue_1, float CallFunc_Subtract_FloatFloat_ReturnValue_1, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_3, class UCommonButton* K2Node_ComponentBoundEvent_Button_4, enum class EFortDialogResult K2Node_CustomEvent_Result_1, class FName K2Node_CustomEvent_ResultName_1, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_12, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_10, bool CallFunc_IsValid_ReturnValue_14, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_5, bool CallFunc_IsMobileGame_ReturnValue, bool CallFunc_IsShippingBuild_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button_3, enum class ESlateVisibility K2Node_Select_Default_3, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_13, class AFortPlayerController* K2Node_DynamicCast_AsFort_Player_Controller, bool K2Node_DynamicCast_bSuccess_4, class UFortAsyncAction_ShowConfirmation_NUI* CallFunc_ShowSimpleConfirmationDialog_NUI_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_15, class FName K2Node_Event_TabNameId, const class FString& K2Node_Event_SettingToSelect, class UCommonButton* K2Node_ComponentBoundEvent_Button_2, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_14, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_11, bool CallFunc_IsValid_ReturnValue_16, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_6, bool CallFunc_ShouldShowNewMOTD_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_19, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_15, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_12, bool CallFunc_IsValid_ReturnValue_17, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_16, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_13, class UCommonButton* K2Node_ComponentBoundEvent_Button_1, bool CallFunc_IsValid_ReturnValue_18, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_7, bool CallFunc_IsShippingBuild_ReturnValue_1, enum class ESlateVisibility K2Node_Select_Default_4, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_14, bool CallFunc_IsValid_ReturnValue_19, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_8, TSoftClassPtr<class UUserWidget> K2Node_Select_Default_5, enum class EFortDialogResult Temp_byte_Variable_13, class UFortAsyncAction_CreateWidgetAsync* CallFunc_CreateWidgetAsync_ReturnValue_15, bool CallFunc_IsValid_ReturnValue_20, bool K2Node_SwitchEnum_CmpSuccess_1, class UCommonButton* K2Node_ComponentBoundEvent_Button, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_9, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue_17, const struct FVector& CallFunc_GetActorEyesViewPoint_OutLocation, const struct FRotator& CallFunc_GetActorEyesViewPoint_OutRotation, const struct FTransform& CallFunc_MakeTransform_ReturnValue, bool CallFunc_IsMobileGame_ReturnValue_1, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class ACreativeIslandJsonExporter* CallFunc_FinishSpawningActor_ReturnValue, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue_10, enum class ESlateVisibility K2Node_Select_Default_6)
{
	static class UFunction* Func = nullptr;
	...
	Parms.K2Node_Event_SettingToSelect = K2Node_Event_SettingToSelect;
	...
	Parms.CallFunc_GetRuntimeOptions_ReturnValue_10 = CallFunc_GetRuntimeOptions_ReturnValue_10;
