...
void UAthenaDirectAcquisitionMTXDetails_C::BndEvt__CloseButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature(class UCommonButton* Button)
{
	...
	Params::UAthenaDirectAcquisitionMTXDetails_C_BndEvt__CloseButton_K2Node_ComponentBoundEvent_0_CommonButtonClicked__DelegateSignature_Params Parms{};
...
void UAthenaDirectAcquisitionMTXDetails_C::ExecuteUbergraph_AthenaDirectAcquisitionMTXDetails(int32 EntryPoint, const struct FDataTableRowHandle& K2Node_MakeStruct_DataTableRowHandle, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool K2Node_CustomEvent_bSuccess, TArray<struct FPurchasedItemInfo>& K2Node_CustomEvent_PurchasedItems, const class FString& K2Node_CustomEvent_OfferId, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue, const class FString& CallFunc_GetOfferId_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue_1, const class FString& CallFunc_GetOfferId_ReturnValue_1, class UCommonButton* K2Node_ComponentBoundEvent_Button_3, class UAthenaAccountContext* CallFunc_GetContext_ReturnValue, class FText CallFunc_GetCurrentSeasonNumberAsText_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button_2, bool CallFunc_HandleBack_PassThrough, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue_2, class UAthenaAccountContext* CallFunc_GetContext_ReturnValue_1, bool CallFunc_IsGiftable_ReturnValue, class FText CallFunc_GetCurrentSeasonNumberAsText_ReturnValue_1, const class FString& CallFunc_GetOfferId_ReturnValue_2, class UCommonButton* K2Node_ComponentBoundEvent_Button_1, class UFortMcpContext* CallFunc_GetContext_ReturnValue_2, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, enum class EOfferPurchaseError CallFunc_PurchaseOffer_ReturnValue, class UGiftingScreen_C* CallFunc_Create_ReturnValue, bool CallFunc_IsMobileGame_ReturnValue, class UFortStoreFrontOfferInfo* CallFunc_GetOfferInfo_ReturnValue_3, class UAthenaAccountContext* CallFunc_GetContext_ReturnValue_3, class FText CallFunc_GetCurrentChapterNumberAsText_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue_4, class UFortMcpContext* CallFunc_GetContext_ReturnValue_5, enum class EOfferPurchaseError CallFunc_CanGiftOffer_ReturnValue, enum class EOfferPurchaseError CallFunc_CanPurchaseOffer_ReturnValue, bool K2Node_SwitchEnum_CmpSuccess, bool CallFunc_EqualEqual_ByteByte_ReturnValue, class UCommonButton* K2Node_ComponentBoundEvent_Button)
{
	static class UFunction* Func = nullptr;
