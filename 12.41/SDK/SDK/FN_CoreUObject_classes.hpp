...
{
public:
	uint8                                        Pad_51[0x70];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_52[0x10];                                      // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	...
	uint8                                        Pad_53[0x6C];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_55[0x20];                                      // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	enum class EClassCastFlags                   CastFlags;                                         // (0xE8[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_56[0x40];                                      // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	class UObject*                               DefaultObject;                                     // (0x130[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_57[0x110];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_58[0x48];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5C[0x20];                                      // Fixing Size After Last (Predefined) Property  [ Dumper-7 ]
	FNativeFuncPtr                               ExecFunction;                                      // (0xF0[0x08]) NOT AUTO-GENERATED PROPERTY

	static class UClass* StaticClass();
	static class UFunction* GetDefaultObj();

	void*& GetFunc() { return *(void**)(__int64(this) + 0xf0); }
...
{
public:
	uint8                                        Pad_5E[0x80];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_60[0xB8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_66[0x1B8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_67[0xA0];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6B[0x40];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_6E[0x10];                                      // Fixing Size Of Struct [ Dumper-7 ]
