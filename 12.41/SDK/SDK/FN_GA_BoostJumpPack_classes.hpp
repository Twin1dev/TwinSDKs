...
public:
	...
	class UAbilityTask_WaitGameplayTagAdded*     HidingInPropTagTask;                               // 0xBD0(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	void Setup_PlayerPawn(FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate);
