...
class UClass* UPlayerBanner_rectangle_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PlayerBanner_rectangle_C");

	return Clss;
}


// PlayerBanner_rectangle_C PlayerBanner_rectangle.Default__PlayerBanner_rectangle_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UPlayerBanner_rectangle_C* UPlayerBanner_rectangle_C::GetDefaultObj()
{
	static class UPlayerBanner_rectangle_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UPlayerBanner_rectangle_C*>(UPlayerBanner_rectangle_C::StaticClass()->DefaultObject);
...
void UPlayerBanner_rectangle_C::ShouldShowAthenaBanner(bool* ShowAthenaBanner, class UFortRuntimeOptions* CallFunc_GetRuntimeOptions_ReturnValue, class UFortGlobalUIContext* CallFunc_GetContext_ReturnValue, enum class ESubGame CallFunc_GetSubGame_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_BooleanOR_ReturnValue)
{
	...
	Params::UPlayerBanner_rectangle_C_ShouldShowAthenaBanner_Params Parms{};
...
void UPlayerBanner_rectangle_C::UnbindDelegates(class UFortPartyContext* CallFunc_GetContext_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UFortUITeamInfo* CallFunc_GetLocalPlayerTeam_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UFortMcpContext* CallFunc_GetContext_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPlayerBanner_rectangle_C_UnbindDelegates_Params Parms{};
...
void UPlayerBanner_rectangle_C::SetupSurround(const struct FMargin& K2Node_MakeStruct_Margin, class ULoadGuardSlot* K2Node_DynamicCast_AsLoad_Guard_Slot, bool K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPlayerBanner_rectangle_C_SetupSurround_Params Parms{};
...
void UPlayerBanner_rectangle_C::SetBannerIconAndColorFromProfile(bool CallFunc_ShouldShowAthenaBanner_ShowAthenaBanner, class UFortMcpContext* CallFunc_GetContext_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue_1, const struct FFortHomeBaseInfo& CallFunc_GetHomeBaseInfoForPlayer_Result, const struct FFortAthenaLoadout& CallFunc_GetLoadoutForPlayer_ReturnValue, bool CallFunc_SetBannerImage_Success, class FName CallFunc_Conv_StringToName_ReturnValue, class FName CallFunc_Conv_StringToName_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPlayerBanner_rectangle_C_SetBannerIconAndColorFromProfile_Params Parms{};
...
void UPlayerBanner_rectangle_C::SetBannerIconAndColor(class FName IconId, class FName ColorId)
{
	...
	Params::UPlayerBanner_rectangle_C_SetBannerIconAndColor_Params Parms{};
...
void UPlayerBanner_rectangle_C::ToggleBannerMask(bool Enable, bool Temp_bool_Variable, float Temp_float_Variable, float Temp_float_Variable_1, class UMaterialInstanceDynamic* CallFunc_GetBannerMID_BannerMID, float K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPlayerBanner_rectangle_C_ToggleBannerMask_Params Parms{};
...
void UPlayerBanner_rectangle_C::RefreshSurround(int32 Level, const struct FAthenaSeasonBannerLevel& CallFunc_GetSeasonBannerInfo_ReturnValue, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue, class UObject* CallFunc_Conv_SoftObjectReferenceToObject_ReturnValue, bool CallFunc_IsAssetNull_ReturnValue, class UMaterialInterface* K2Node_DynamicCast_AsMaterial_Interface, bool K2Node_DynamicCast_bSuccess, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate)
{
	...
	Params::UPlayerBanner_rectangle_C_RefreshSurround_Params Parms{};
...
void UPlayerBanner_rectangle_C::OnSurroundIconLoaded(class UObject* LoadedObject, class UTexture* K2Node_DynamicCast_AsTexture, bool K2Node_DynamicCast_bSuccess, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPlayerBanner_rectangle_C_OnSurroundIconLoaded_Params Parms{};
...
void UPlayerBanner_rectangle_C::OnBannerIconLoaded(class UObject* LoadedObject, class UMaterialInstanceDynamic* CallFunc_GetBannerMID_BannerMID, class UTexture* K2Node_DynamicCast_AsTexture, bool K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPlayerBanner_rectangle_C_OnBannerIconLoaded_Params Parms{};
...
void UPlayerBanner_rectangle_C::GetBannerMID(class UMaterialInstanceDynamic** BannerMID, class UMaterialInstanceDynamic* CallFunc_GetDynamicMaterial_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPlayerBanner_rectangle_C_GetBannerMID_Params Parms{};
...
void UPlayerBanner_rectangle_C::SetBannerOwner(const struct FUniqueNetIdRepl& OwnerId, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, class UFortPartyContext* CallFunc_GetContext_ReturnValue, bool CallFunc_IsValid_UniqueNetIdRepl_ReturnValue, class UFortUITeamInfo* CallFunc_GetLocalPlayerTeam_ReturnValue, class UFortMcpContext* CallFunc_GetContext_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPlayerBanner_rectangle_C_SetBannerOwner_Params Parms{};
...
void UPlayerBanner_rectangle_C::SetBannerColorId(class FName InBannerColorId, class UMaterialInstanceDynamic* CallFunc_GetBannerMID_BannerMID, bool CallFunc_NotEqual_NameName_ReturnValue, const struct FHomebaseBannerColor& CallFunc_GetBannerColorFromRowName_ReturnValue, class UMaterialInstanceDynamic* CallFunc_GetBannerMID_BannerMID_1, const struct FLinearColor& CallFunc_GetSecondaryColor_ReturnValue, const struct FLinearColor& CallFunc_GetPrimaryColor_ReturnValue, bool CallFunc_NotEqual_NameName_ReturnValue_1)
{
	...
	Params::UPlayerBanner_rectangle_C_SetBannerColorId_Params Parms{};
...
void UPlayerBanner_rectangle_C::SetBannerIconId(class FName InBannerIconId, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool Temp_bool_Option_B___If_false__use_Option_A_Variable, bool CallFunc_NotEqual_NameName_ReturnValue, bool Temp_bool_Variable, TSoftObjectPtr<class UTexture2D> CallFunc_GetBannerSmallIconAssetFromRowName_ReturnValue, TSoftObjectPtr<class UTexture2D> CallFunc_GetBannerLargeIconAssetFromRowName_ReturnValue, TSoftObjectPtr<class UObject> K2Node_Select_Default, class UMaterialInstanceDynamic* CallFunc_GetBannerMID_BannerMID, bool CallFunc_NotEqual_NameName_ReturnValue_1)
{
	...
	Params::UPlayerBanner_rectangle_C_SetBannerIconId_Params Parms{};
...
void UPlayerBanner_rectangle_C::SetBannerImage(const struct FFortHomeBaseInfo& Image_info, bool* Success, class FName CallFunc_Conv_StringToName_ReturnValue, class FName CallFunc_Conv_StringToName_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
	...
	Params::UPlayerBanner_rectangle_C_SetBannerImage_Params Parms{};
...
void UPlayerBanner_rectangle_C::OnTeamMemberStateChanged(const struct FFortTeamMemberInfo& TeamMemberInfo)
{
	...
	Params::UPlayerBanner_rectangle_C_OnTeamMemberStateChanged_Params Parms{};
...
void UPlayerBanner_rectangle_C::Account_Info_Changed(const struct FFortPublicAccountInfo& NewInfo)
{
	...
	Params::UPlayerBanner_rectangle_C_Account_Info_Changed_Params Parms{};
...
void UPlayerBanner_rectangle_C::ExecuteUbergraph_PlayerBanner_rectangle(int32 EntryPoint, bool CallFunc_ShouldShowAthenaBanner_ShowAthenaBanner, const struct FFortTeamMemberInfo& K2Node_CustomEvent_TeamMemberInfo, bool CallFunc_IsValid_UniqueNetIdRepl_ReturnValue, bool CallFunc_SetBannerImage_Success, bool CallFunc_EqualEqual_UniqueNetIdReplUniqueNetIdRepl_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, const struct FFortPublicAccountInfo& K2Node_CustomEvent_NewInfo)
{
	...
	Params::UPlayerBanner_rectangle_C_ExecuteUbergraph_PlayerBanner_rectangle_Params Parms{};
