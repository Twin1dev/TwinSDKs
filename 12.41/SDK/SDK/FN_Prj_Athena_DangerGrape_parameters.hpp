...
public:
	...
	uint8                                        Pad_64CF[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_64D0[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	class AFortWaterBodyActor*                   K2Node_ComponentBoundEvent_WaterBody;              // 0x90(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class UFortWaterInteractionComponent*        K2Node_ComponentBoundEvent_WaterInteractionComponent; // 0x98(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_ComponentBoundEvent_bIsFirstBody;           // 0xA0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	struct FHitResult                            K2Node_Event_Hit_1;                                // 0xB0(0x8C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FHitResult                            K2Node_Event_Hit;                                  // 0x180(0x8C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	float                                        CallFunc_Dot_VectorVector_ReturnValue;             // 0x20C(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         Temp_bool_IsClosed_Variable;                       // 0x210(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
