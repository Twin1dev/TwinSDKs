...
public:
	...
	void TestDynColor();
	void ExecuteUbergraph_Frontend_Lobby_Background(int32 EntryPoint, class UTexture* K2Node_ActorBoundEvent_BackgroundImage, bool K2Node_SwitchString_CmpSuccess, const class FString& K2Node_ActorBoundEvent_PresetEnvironmentName, float CallFunc_GetScalarParameterValue_ReturnValue, const struct FLinearColor& CallFunc_MakeColor_ReturnValue, float CallFunc_GetScalarParameterValue_ReturnValue_1, bool Temp_bool_Variable, bool CallFunc_Not_PreBool_ReturnValue, class USceneComponent* CallFunc_K2_GetRootComponent_ReturnValue, class USceneComponent* CallFunc_K2_GetRootComponent_ReturnValue_1);
};
