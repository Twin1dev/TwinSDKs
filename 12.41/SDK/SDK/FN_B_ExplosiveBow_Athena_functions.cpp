...
class UClass* AB_ExplosiveBow_Athena_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("B_ExplosiveBow_Athena_C");

	return Clss;
}


// B_ExplosiveBow_Athena_C B_ExplosiveBow_Athena.Default__B_ExplosiveBow_Athena_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AB_ExplosiveBow_Athena_C* AB_ExplosiveBow_Athena_C::GetDefaultObj()
{
	static class AB_ExplosiveBow_Athena_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AB_ExplosiveBow_Athena_C*>(AB_ExplosiveBow_Athena_C::StaticClass()->DefaultObject);
