...
class UClass* UAthenaArmoryTab_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AthenaArmoryTab_C");

	return Clss;
}


// AthenaArmoryTab_C AthenaArmoryTab.Default__AthenaArmoryTab_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAthenaArmoryTab_C* UAthenaArmoryTab_C::GetDefaultObj()
{
	static class UAthenaArmoryTab_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAthenaArmoryTab_C*>(UAthenaArmoryTab_C::StaticClass()->DefaultObject);
