...
struct UFeedback_C_Update_Send_Button_Enabled_Params
{
public:
...
struct UFeedback_C_BndEvt__CloseButton_K2Node_ComponentBoundEvent_7_CommonButtonClicked__DelegateSignature_Params
{
public:
	class UCommonButton*                         Button;                                            // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	class UCommonButton*                         K2Node_ComponentBoundEvent_Button_5;               // 0x10(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	class FText                                  K2Node_CustomEvent_Text;                           // 0x18(0x18)(ConstParm)
	enum class EFortUIGameFeedbackType           K2Node_Event_FeedbackType;                         // 0x30(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
