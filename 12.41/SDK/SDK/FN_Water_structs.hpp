...
public:
	...
	uint8                                        Pad_1E9E[0x14];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	class UMaterialInterface*                    UnderwaterPostProcessMaterial;                     // 0x540(0x8)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1EA1[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
