...
{
public:
	uint8                                        Pad_3A07[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_3A09[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_3A0C[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	TMap<class FName, int32>                     NameMap;                                           // 0x48(0x50)(ZeroConstructor, Transient, NativeAccessSpecifierPrivate)
};
