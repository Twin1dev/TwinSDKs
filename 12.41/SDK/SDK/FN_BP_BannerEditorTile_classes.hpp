...
public:
	...
	FMulticastInlineDelegateProperty_            BannerTileBangUpdated;                             // 0xBC0(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable, BlueprintCallable)
