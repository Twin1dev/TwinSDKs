...
// SequenceDirector_C S12_BuffcatRoom_ToElevator.Default__SequenceDirector_C
...
void USequenceDirector_C::SequenceEvent__ENTRYPOINTSequenceDirector_1(class ABP_Battlepass_LightSwitcher_C* BP_Battlepass_LightSwitcher_Meowscles)
{
	static class UFunction* Func = nullptr;
...
void USequenceDirector_C::BP_Battlepass_LightSwitcher_Meowscles_Event_0(class ABP_Battlepass_LightSwitcher_C* BP_Battlepass_LightSwitcher_Meowscles)
{
	static class UFunction* Func = nullptr;
	...
	Params::USequenceDirector_C_BP_Battlepass_LightSwitcher_Meowscles_Event_0_Params Parms{};
...
// class ABP_Battlepass_LightSwitcher_C*K2Node_CustomEvent_BP_Battlepass_LightSwitcher_Meowscles         (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void USequenceDirector_C::ExecuteUbergraph_SequenceDirector(int32 EntryPoint, bool CallFunc_IsReversed_ReturnValue, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition_7, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition_6, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition_5, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition3_5, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition3_4, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition_4, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition_3, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition3_3, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition3_2, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition3_1, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition3, class ABP_Battlepass_LightSwitcher_C* K2Node_CustomEvent_BP_Battlepass_LightSwitcher_Maproom_2, class ABP_Battlepass_LightSwitcher_C* K2Node_CustomEvent_BP_Battlepass_LightSwitcher_Hench, class USoundBase* K2Node_CustomEvent_Sound, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition_2, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition_1, class ABP_Elevator_Transition_C* K2Node_CustomEvent_BP_Elevator_Transition, class ABP_Battlepass_LightSwitcher_C* K2Node_CustomEvent_BP_Battlepass_LightSwitcher_TNTINA, class ABP_Battlepass_LightSwitcher_C* K2Node_CustomEvent_BP_Battlepass_LightSwitcher_Maproom_1, bool CallFunc_IsReversed_ReturnValue_1, class ABP_Battlepass_LightSwitcher_C* K2Node_CustomEvent_BP_Battlepass_LightSwitcher_Meowscles, bool CallFunc_IsReversed_ReturnValue_2, class ABP_Battlepass_LightSwitcher_C* K2Node_CustomEvent_BP_Battlepass_LightSwitcher_Maproom, bool CallFunc_IsReversed_ReturnValue_3)
{
	...
	Parms.K2Node_CustomEvent_BP_Battlepass_LightSwitcher_Meowscles = K2Node_CustomEvent_BP_Battlepass_LightSwitcher_Meowscles;
