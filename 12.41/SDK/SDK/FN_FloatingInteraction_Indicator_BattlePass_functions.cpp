...
void UFloatingInteraction_Indicator_BattlePass_C::SetCATextFX(class FText CallFunc_GetText_ReturnValue)
{
	...
	Params::UFloatingInteraction_Indicator_BattlePass_C_SetCATextFX_Params Parms{};
