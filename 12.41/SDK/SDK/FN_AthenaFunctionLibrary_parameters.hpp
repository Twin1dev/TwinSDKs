...
public:
	...
	uint8                                        Pad_5648[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	TArray<class AFortPickup*>                   ItemPickupsSpawned;                                // 0x50(0x10)(Parm, OutParm, ZeroConstructor)
	TArray<class AFortPickup*>                   PickupsSpawned;                                    // 0x60(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate)
	...
	struct FFortItemEntry                        CallFunc_Array_Get_Item;                           // 0xA0(0x150)(None)
...
public:
	...
	uint8                                        Pad_5656[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
