...
void UAthenaCustomizationSlotButtonWrapper_C::ResetPopulateAnimVisual(float CallFunc_GetEndTime_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue)
{
	...
	Params::UAthenaCustomizationSlotButtonWrapper_C_ResetPopulateAnimVisual_Params Parms{};
...
void UAthenaCustomizationSlotButtonWrapper_C::SetCardImage(TSoftObjectPtr<class UObject> InImage)
{
	...
	Params::UAthenaCustomizationSlotButtonWrapper_C_SetCardImage_Params Parms{};
...
void UAthenaCustomizationSlotButtonWrapper_C::AnimPopulateInternal(int32 ButtonIndex)
{
	...
	Params::UAthenaCustomizationSlotButtonWrapper_C_AnimPopulateInternal_Params Parms{};
