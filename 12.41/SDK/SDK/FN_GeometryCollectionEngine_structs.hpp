...
public:
	...
	uint8                                        Pad_36A9[0x14];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	int32                                        ParticleIndex;                                     // 0x1C(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_36AA[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_36AB[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_36AE[0x1];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
