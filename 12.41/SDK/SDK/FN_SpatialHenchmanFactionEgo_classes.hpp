...
class USpatialHenchmanFactionEgo_C : public UCommonButton
{
public:
	...
	struct FEventReply OnFocusReceived(const struct FGeometry& MyGeometry, const struct FFocusEvent& InFocusEvent, const struct FEventReply& K2Node_MakeStruct_EventReply, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue);
	void InitForVariant(class UFortVariantTokenType* Variant, enum class EMissionState MissionState, enum class EMissionState OtherMissionState, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue_1, bool CallFunc_IsValid_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, class FText CallFunc_GetDisplayName_ReturnValue, enum class EMissionState Temp_byte_Variable, class UWidget* K2Node_Select_Default);
