...
class UClass* UGCN_Athena_GenericHeldObject_Throw_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Athena_GenericHeldObject_Throw_C");

	return Clss;
}


// GCN_Athena_GenericHeldObject_Throw_C GCN_Athena_GenericHeldObject_Throw.Default__GCN_Athena_GenericHeldObject_Throw_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Athena_GenericHeldObject_Throw_C* UGCN_Athena_GenericHeldObject_Throw_C::GetDefaultObj()
{
	static class UGCN_Athena_GenericHeldObject_Throw_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Athena_GenericHeldObject_Throw_C*>(UGCN_Athena_GenericHeldObject_Throw_C::StaticClass()->DefaultObject);
