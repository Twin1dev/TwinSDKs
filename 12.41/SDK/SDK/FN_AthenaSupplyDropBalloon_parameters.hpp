...
public:
	...
	struct FHitResult                            K2Node_Event_HitInfo_2;                            // 0x3C(0x8C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FHitResult                            K2Node_Event_HitInfo_1;                            // 0x14C(0x8C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	struct FHitResult                            K2Node_Event_HitInfo;                              // 0x234(0x8C)(ConstParm, IsPlainOldData, NoDestructor, ContainsInstancedReference)
