...
struct UGAB_InterrogatePlayer_Search_C_ApplyGameplayEffectToHenchman_Params
{
public:
	...
	uint8                                        Pad_59B6[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	TArray<struct FFortItemEntry>                CallFunc_PickLootDrops_OutLootToDrop;              // 0x20(0x10)(ZeroConstructor, ReferenceParm)
	...
	struct FFortItemEntry                        CallFunc_Array_Get_Item;                           // 0x38(0x150)(None)
	...
	bool                                         CallFunc_IsValid_ReturnValue_1;                    // 0x19A(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class AFortPickup*                           CallFunc_K2_SpawnPickupInWorld_ReturnValue;        // 0x1C0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
public:
	...
	class AFortPlayerPawn*                       CallFunc_GetDBNOHoistee_ReturnValue;               // 0x58(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct FGameplayAbilityTargetDataHandle      CallFunc_AbilityTargetDataFromActor_ReturnValue;   // 0x78(0x28)(None)
	TArray<struct FActiveGameplayEffectHandle>   CallFunc_BP_ApplyGameplayEffectToTarget_ReturnValue; // 0xA0(0x10)(ZeroConstructor, ReferenceParm)
};
