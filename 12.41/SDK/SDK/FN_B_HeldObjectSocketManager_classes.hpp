...
public:
	...
	TArray<class AB_HeldObjectSocket_C*>         HeldObjectSockets;                                 // 0x798(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, ExposeOnSpawn)
	TArray<struct FGameplayTagContainer>         CurrentTags;                                       // 0x7A8(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	TArray<struct FGameplayTagContainer>         DefaultCorrectTags;                                // 0x7B8(0x10)(Edit, BlueprintVisible, ZeroConstructor, ExposeOnSpawn)
	bool                                         CombinationCorrect;                                // 0x7C8(0x1)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, RepNotify, NoDestructor)
	bool                                         SocketOrderMatters;                                // 0x7C9(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
