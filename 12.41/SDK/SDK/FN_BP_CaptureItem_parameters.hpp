...
public:
	...
	uint8                                        Pad_16D9[0xE];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_16E0[0x6];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	struct FHitResult                            CallFunc_K2_SetRelativeLocationAndRotation_SweepHitResult; // 0x48(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	class AFortWrapSkeletalMeshActor*            K2Node_DynamicCast_AsFort_Wrap_Skeletal_Mesh_Actor; // 0xD8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0xE0(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	uint8                                        Pad_16FB[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	class ACustomItemWrapModifier*               CallFunc_GetWrapModifier_ReturnValue;              // 0xE8(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
