...
class UClass* UNiagaraShaderStageBase::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("NiagaraShaderStageBase");

	return Clss;
}


// NiagaraShaderStageBase Niagara.Default__NiagaraShaderStageBase
// (Public, ClassDefaultObject, ArchetypeObject)

class UNiagaraShaderStageBase* UNiagaraShaderStageBase::GetDefaultObj()
{
	static class UNiagaraShaderStageBase* Default = nullptr;

	if (!Default)
		Default = static_cast<UNiagaraShaderStageBase*>(UNiagaraShaderStageBase::StaticClass()->DefaultObject);
...
class UClass* UNiagaraShaderStagePlaceholderA::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("NiagaraShaderStagePlaceholderA");

	return Clss;
}


// NiagaraShaderStagePlaceholderA Niagara.Default__NiagaraShaderStagePlaceholderA
// (Public, ClassDefaultObject, ArchetypeObject)

class UNiagaraShaderStagePlaceholderA* UNiagaraShaderStagePlaceholderA::GetDefaultObj()
{
	static class UNiagaraShaderStagePlaceholderA* Default = nullptr;

	if (!Default)
		Default = static_cast<UNiagaraShaderStagePlaceholderA*>(UNiagaraShaderStagePlaceholderA::StaticClass()->DefaultObject);
...
class UClass* UNiagaraShaderStagePlaceholderB::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("NiagaraShaderStagePlaceholderB");

	return Clss;
}


// NiagaraShaderStagePlaceholderB Niagara.Default__NiagaraShaderStagePlaceholderB
// (Public, ClassDefaultObject, ArchetypeObject)

class UNiagaraShaderStagePlaceholderB* UNiagaraShaderStagePlaceholderB::GetDefaultObj()
{
	static class UNiagaraShaderStagePlaceholderB* Default = nullptr;

	if (!Default)
		Default = static_cast<UNiagaraShaderStagePlaceholderB*>(UNiagaraShaderStagePlaceholderB::StaticClass()->DefaultObject);
