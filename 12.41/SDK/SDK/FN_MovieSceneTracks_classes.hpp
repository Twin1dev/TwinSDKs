...
{
public:
	TArray<struct FScalarParameterNameAndCurve>  ScalarParameterNamesAndCurves;                     // 0xE0(0x10)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FVectorParameterNameAndCurves> VectorParameterNamesAndCurves;                     // 0xF0(0x10)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FColorParameterNameAndCurves>  ColorParameterNamesAndCurves;                      // 0x100(0x10)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	TArray<struct FTransformParameterNameAndCurves> TransformParameterNamesAndCurves;                  // 0x110(0x10)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                        Pad_164C[0x2];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	TArray<class FString>                        ActorGuidStrings;                                  // 0x210(0x10)(ZeroConstructor, Deprecated, NativeAccessSpecifierPrivate)
...
{
public:
	struct FMovieSceneCameraShakeSourceTriggerChannel Channel;                                           // 0xE0(0x88)(NativeAccessSpecifierPrivate)
