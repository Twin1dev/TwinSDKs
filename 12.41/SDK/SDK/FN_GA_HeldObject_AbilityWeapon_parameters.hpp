...
public:
	...
	TArray<class AActor*>                        CallFunc_GetAttachedActors_OutActors;              // 0x1A0(0x10)(ZeroConstructor, ReferenceParm)
	TArray<class AActor*>                        CallFunc_FilterArray_FilteredArray;                // 0x1B0(0x10)(ZeroConstructor, ReferenceParm)
