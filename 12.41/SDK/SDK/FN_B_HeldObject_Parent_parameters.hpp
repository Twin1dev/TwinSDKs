...
{
public:
	struct FHitResult                            CallFunc_K2_SetActorRelativeLocation_SweepHitResult; // 0x0(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	struct FActiveGameplayEffectHandle           CallFunc_ApplyGlobalEnvironmentGameplayEffectToActor_ReturnValue; // 0x8C(0x8)(NoDestructor, HasGetValueTypeHash)
};
