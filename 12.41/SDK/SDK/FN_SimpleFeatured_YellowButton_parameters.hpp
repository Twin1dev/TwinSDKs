...
public:
	...
	uint8                                        Pad_6E1E[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	class FText                                  NewText;                                           // 0x0(0x18)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm)
};
...
public:
	...
	uint8                                        Pad_6E24[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	bool                                         K2Node_Event_IsDesignTime;                         // 0x27(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
	...
	class FText                                  K2Node_Event_NewText_1;                            // 0x50(0x18)(ConstParm)
	...
	class FText                                  K2Node_Event_NewText;                              // 0x78(0x18)(ConstParm)
	...
	uint8                                        Pad_6E27[0x5];                                     // Fixing Size After Last Property  [ Dumper-7 ]
