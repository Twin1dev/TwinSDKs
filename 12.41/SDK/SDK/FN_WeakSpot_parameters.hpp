...
public:
	...
	uint8                                        Pad_4E5E[0xC];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FTransform                            CallFunc_MakeTransform_ReturnValue;                // 0xB0(0x30)(IsPlainOldData, NoDestructor)
	struct FHitResult                            CallFunc_K2_SetWorldTransform_SweepHitResult;      // 0xE0(0x8C)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	...
	int32                                        CallFunc_Clamp_ReturnValue;                        // 0x188(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
