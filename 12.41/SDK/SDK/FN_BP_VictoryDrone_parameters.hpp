...
{
public:
	TArray<struct FParticleSysParam>             Instance_Parameters;                               // 0x0(0x10)(Parm, OutParm, ZeroConstructor)
	...
	TArray<struct FParticleSysParam>             K2Node_MakeArray_Array;                            // 0x490(0x10)(ZeroConstructor, ReferenceParm)
};
...
public:
	...
	class UAnimMontage*                          K2Node_CustomEvent_Montage;                        // 0x18(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_CustomEvent_bInterrupted;                   // 0x20(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor)
