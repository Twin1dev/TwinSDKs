...
public:
	...
	bool                                         HasLandedAfterBeam;                                // 0xC10(0x1)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor)
	uint8                                        Pad_6487[0x7];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGameplayTagContainer                 Carmine_Ability_Tags;                              // 0xC18(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	TArray<struct FGameplayTag>                  StoneTags;                                         // 0xC38(0x10)(Edit, BlueprintVisible, Net, ZeroConstructor, DisableEditOnInstance, RepNotify)
	TArray<struct FGameplayTag>                  GemTags;                                           // 0xC48(0x10)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
	int32                                        Int;                                               // 0xC58(0x4)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_6488[0x4];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	struct FGameplayTagContainer                 SkydiveCue;                                        // 0xC60(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
	struct FGameplayTagContainer                 TrailsCue;                                         // 0xC80(0x20)(Edit, BlueprintVisible, DisableEditOnInstance)
