...
struct AGCNL_Uncle_Dash_Charging_C_OnLoopingStart_Params
{
public:
...
struct AGCNL_Uncle_Dash_Charging_C_OnRemoval_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	struct FGameplayCueParameters                Parameters;                                        // 0x8(0xB8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGCNL_Uncle_Dash_Charging_C_ExecuteUbergraph_GCNL_Uncle_Dash_Charging_Params
{
public:
	...
	class UParticleSystemComponent*              CallFunc_Array_Get_Item;                           // 0x1E0(0x8)(ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
