...
class UClass* UGCN_Athena_GenericHeldObject_HitWorld_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GCN_Athena_GenericHeldObject_HitWorld_C");

	return Clss;
}


// GCN_Athena_GenericHeldObject_HitWorld_C GCN_Athena_GenericHeldObject_HitWorld.Default__GCN_Athena_GenericHeldObject_HitWorld_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGCN_Athena_GenericHeldObject_HitWorld_C* UGCN_Athena_GenericHeldObject_HitWorld_C::GetDefaultObj()
{
	static class UGCN_Athena_GenericHeldObject_HitWorld_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGCN_Athena_GenericHeldObject_HitWorld_C*>(UGCN_Athena_GenericHeldObject_HitWorld_C::StaticClass()->DefaultObject);
